...
export class  EMailVorlagen  extends Component{
    render(){
        return(
            <div>
                <Header />
						      ...
						      <div className="col-lg-12">
						        ...
						        <Tabs>
			                      	<TabList className="nav-tabs TicketInfoTabs">
			                        	<Tab>Einladung</Tab>
				                        <Tab>Aktivierung</Tab>
				                        <Tab>Deaktivierung</Tab>
				                     </TabList>
			                    
							        <div className="Setting_right_scroll">
							            <TabPanel>
							                        ...
							                        <div className="col-md-12">
							                          <div className="form-group">
							                            ...
							                            <select name id className="form-control chosen-select">
							                              <option value={0}>Einladender Agent – E-Mail-Adresse</option>
							                              <option value>support@oneixgmbh377.oneixdesk.eu</option>
							                            </select>
							                          </div>
							                        </div>
							                        <div className="col-md-12">
							                          <div className="form-group">
							                            ...
							                            <input className="form-control" placeholder="Eg. johnoneix.eu" />
							                          </div>
							                        </div>
							                        <div className="col-md-12">
							                          <div className="form-group">
							                            <label className="label-red">Betreff</label>
							                            <input className="form-control" defaultValue=" Organization.Organization Name - Customer Self Service Portal Invitation" />
							                          </div>
							                        </div>
							                      </div>
							                    </div>
							                      ...
							                      <div id="einladung-editor">
							                        <div className="einladung-editor-scroll">
							                          <div className="einladung-editor-outer">
							                            <p>${'{'}Organization.Organization Logo{'}'}</p>
							                            <div className="einladung-editor-inner">
							                              <h1>Welcome ${'{'}User.First Name{'}'} ${'{'}User.Last Name{'}'}!</h1>
							                              <p>You are invited to access ${'{'}Organization.Organization Name{'}'}'s ${'{'}PortalUser.PORTAL_URL::Customer Self Service Portal{'}'}</p>
							                              <p>By accessing this portal, you can track your requests online, access knowledge base and join the community forums.</p>
							                              <p>${'{'}PortalUser.ACCEPT_PORTAL_INVITATION_BUTTON{'}'}</p>
							                              <p>our user name is <span className="link-blue">${'{'}User.Email{'}'}</span> | You can also <span className="link-blue">${'{'}PortalUser.ACCEPT_PORTAL_INVITATION::click here{'}'}
							                                </span> to accept the invitation</p>
							                              <p>Thank you, ${'{'}Organization.Organization Name{'}'} Administrator</p>
							                            </div>
							                          </div>
							                        </div>
							                      </div>
							                  ...
							                  <div className="row">
							                    <div className="col-md-4">
							                      <div className="row">
							                        ...
							                        <div className="col-md-12">
							                          <div className="form-group">
							                            <label>Antworten an</label>
							                            <input className="form-control" type name placeholder="Eg. johnoneix.eu" />
							                          </div>
							                        </div>
							                        <div className="col-md-12">
							                          <div className="form-group">
							                            <label className="label-red">Betreff</label>
							                            <input className="form-control" type name defaultValue="Organization.Organization Name - Customer Self Service Portal Invitation" />
							                          </div>
							                        </div>
							                      </div>
							                    </div>
							                    <div className="col-md-10">
							                      ...
							                      <div id="einladung-editor">
							                        <div className="einladung-editor-scroll">
							                          <div className="einladung-editor-outer">
							                            <h3>Your User Profile is Reactivated</h3>
							                            <div className="einladung-editor-inner">
							                              <p>${'{'}Organization.Organization Logo{'}'}</p>
							                              <h1>${'{'}Organization.Organization Name{'}'}</h1>
							                              <p>Dear ${'{'}User.First Name{'}'} ${'{'}User.Last Name{'}'} !</p>
							                              <p>Your user profile on ${'{'}Organization.Organization Name{'}'}'s customer support portal has been reactivated.You can sign in and start using everything as usual.</p>
							                              <p>${'{'}PortalUser.CUSTOMER_PORTAL_BUTTON{'}'}</p>
							                              <p>Thank you, ${'{'}Organization.Organization Name{'}'} Administrator.</p>
							                            </div>
							                          </div>
							                        </div>
							                  ...
							                  <div className="row">
							                    ...
							                    <div className="col-md-10">
							                      ...
							                      <div id="einladung-editor">
							                        <div className="einladung-editor-scroll">
							                          <div className="einladung-editor-outer">
							                            <h3>Your User Profile is Deactivated</h3>
							                            <div className="einladung-editor-inner">
							                              <p>${'{'}Organization.Organization Logo{'}'}</p>
							                              <h1>${'{'}Organization.Organization Name{'}'}</h1>
							                              <p>Dear ${'{'}User.First Name{'}'} ${'{'}User.Last Name{'}'} !</p>
							                              <p>Your user profile on ${'{'}Organization.Organization Name{'}'}'s customer support portal has been deactivated. This could be due to inactivity or due to a violation of our terms of use.</p>
							                              <p className="editor-info">Please send an email to ${'{'}PortalAccessCoordinator.Email{'}'} to reactivate your account.</p>
							                              <p>Thank you, ${'{'}Organization.Organization Name{'}'} Administrator.</p>
							                            </div>
							                          </div>
							                        </div>
							        ...
							        <div className="Setting_right_fxd_btns p20" style={{left:'15px'}}>
							          ...
							          <button className="btn-theme-white btn-md">Vorschau</button>
							        </div>
							    </Tabs>
