...
export class SupportManager extends Component{
    render(){
        return(
            <div>
                <Header />
		                ...
		                <div className="setting-right">
							  ...
							  <div className="Setting-right-content bt1px">
							    <div className="profile-setting-scroll">
							      <div className="p20">
							        <div className="mb-4">
							          <div className="profileNameBase"><h2 className="mb-0">Support Manager <Link className="hoverShow"><i className="lnr lnr-pencil" /></Link></h2></div>
							          <div id="profileNameEdit" className="mb-2" style={{display: 'none'}}>
							            <form>
							              <div className="form-row align-items-center">
							                <div className="col-auto">
							                  <input type="text" className="form-control" id defaultValue="Support Manager" />
							                </div>
							                <div className="col-auto">
							                  <Link className="btn link-blue text-sm ">Speichern</Link>
							                  <Link className="btn text-sm ">Abbrechen</Link>
							                </div>
							              </div>
							            </form>
							          </div>
							          <div className="profileDescBase"><p>Legen Sie Berechtigungen für neue Agenten fest. <Link className="hoverShow"><i className="lnr lnr-pencil" /></Link></p></div>
							          <div id="profileDescEdit" className="mb-2" style={{display: 'none'}}>
							            <form>
							              <div className="form-row align-items-center">
							                <div className="col-auto">
							                  <input type="text" className="form-control" id defaultValue="Legen Sie Berechtigungen für neue Agenten fest." />
							                </div>
							                <div className="col-auto">
							                  <Link className="btn link-blue text-sm ">Speichern</Link>
							                  <Link className="btn text-sm ">Abbrechen</Link>
							                    ...
							                    <span className="dropdown">
							                      ...
							                      <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
							                        ...
							                        <div className="drop_btns">
							                          <Link className="btn-theme btn-xs mr-1">Speichern</Link>
							                          <Link className="btn-theme btn-xs">Stornieren</Link>
							                        </div>
							                      </div>
							                    </span>
							                  </div>
							                  ...
							                  <div className="pleft">
							                    ...
							                    <span className="dropdown">
							                      ...
							                      <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
							                        ...
							                        <div className="drop_btns">
							                          <Link className="btn-theme btn-xs mr-1">Speichern</Link>
							                          <Link className="btn-theme btn-xs">Abbrechen</Link>
							                        </div>
							                      </div>
							                    </span>
							                  </div>
