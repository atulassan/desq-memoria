						            ...
						            <div className="col-sm-10">
						              <div className="row">
						                <div className="col-sm-3">
						                  <div className="card" style={{width: '18rem'}}>
						                    <div className="BewertungImg">
						                      <img src="images/emoji-smile.png" alt="emoji-smile" />
						                      <span>Good</span>
						                      <Link  className="BewertungIcon"><i className="lnr lnr-pencil" /></Link>
						                    </div>
						                ...
						                <div className="col-sm-3">
						                  <div className="card" style={{width: '18rem'}}>
						                    <div className="BewertungImg">
						                      <img src="images/emoji-okay.png" alt="emoji-okay" />
						                      <span>Okay</span>
						                      <Link  className="BewertungIcon"><i className="lnr lnr-checkmark-circle" /></Link>
						                    </div>
						                    <ul className="list-group list-group-flush BewertungList">
						                      <li className="list-group-item">
						                        <span>Reaktion auf Bewertung</span> 
						                ...
						                <div className="col-sm-3">
						                  <div className="card" style={{width: '18rem'}}>
						                    <div className="BewertungImg">
						                      <img src="images/emoji-bad.png" alt="emoji-bad" />
						                      <span>Bad</span>
						                      <Link className="BewertungIcon"><i className="lnr lnr-pencil" /></Link>
						                    </div>
						                    <ul className="list-group list-group-flush BewertungList">
						          ...
						          <div className="form-group row">
						            ...
						            <div className="col-sm-3">
						              <select className="form-control chosen-select">
						                <option value>--- Nicht erneut öffnen ---</option>
						                <option value>Für alle Bewertungen</option>
						                <option value>Für schlechte Bewertungen</option>
						              </select>
						            </div>
						          </div>
						          <div className="form-group row">
						          ...
						          <div className="form-group row">
						            ...
						            <div className="col-sm-3">
						              <select className="form-control chosen-select">
						                ...
						                <option value>anita sivakumar</option>
						              </select>
						            </div>
						          </div>
						        </form>
