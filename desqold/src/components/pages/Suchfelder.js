...
export class Suchfelder extends Component{
    render(){
        return(
            <div>
                <Header />
						      ...
						      <div className="col-lg-12">
						        <div className="p20">
						          <div className="Setting_right_scroll">
						          	<Tabs>
							            <TabList className="suchfelder_tab">
							                <Tab>
							                	<label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" defaultChecked="checked" name="cars" defaultValue={2} /><mark className="mr-2" />Alle Felder</label>
							                </Tab>
							                <Tab>
							                	<label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="cars" defaultValue={3} /><mark className="mr-2" />Bestimmte Felder</label>
							                </Tab>
							            </TabList>
						          	

							            <TabPanel>
							              <div className="suchfelderList">
							                <ul>
							                  <li>Konto Name 
							                    <label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" /></label>
							                  </li>
							                  <li>Kontakt Name 
							                    <label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" /></label>
							                  </li>
							            ...
							            <TabPanel>
							              <div className="suchfelderList">
							                <ul>
							                  ...
							                  <li>E-Mail 
							                    <label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" defaultChecked name /><mark className="mr-2" /></label>
							                  </li>
							                  <li>Tel. 
							                    <label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" defaultChecked name /><mark className="mr-2" /></label>
							                  </li>
