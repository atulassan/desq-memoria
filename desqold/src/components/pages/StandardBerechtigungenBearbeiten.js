							  ...
							  <div className="Setting-right-content bt1px">
							    <div className="p20">
							      <table className="table table-bordered DatenfreigabeTable">
							        <tbody>
							          <tr>
							            <td width="20%">Kontos</td>
							            <td width="10%"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Kontos" /><mark className="mr-2" />Privat </label></td>
							            <td width="20%"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Kontos" /><mark className="mr-2" />Öffentliche lesen </label></td>
							            <td width="50%"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Kontos" defaultChecked /><mark className="mr-2" />Öffentliche lesen/Schreiben </label></td>
							          </tr>
							          <tr>
							            <td>Kontakte</td>
