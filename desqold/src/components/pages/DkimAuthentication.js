		                ...
		                <div className="setting-right">
						  ...
						  <div className="Setting-right-content">
						    <table className="table m-0">
						      <thead>
						        <tr>
						          <th className="text-center" width="30%">DOMÄNENNAME</th>
						          <th className="text-center" width="30%">ÜBERPRÜFUNGSSTATUS</th>
						          <th className="text-center" width="20%">LAST VERIFIED</th>
						        </tr>
						      </thead>
						    </table>
