...
export class StandardBerechtigungen extends Component{
    render(){
        return(
            <div>
                <Header />
	                <div className="mainWrapper pl-0">
					  <div className="mainWrapperBody">
		               ...
		               <div class="setting-right">
				            <div class="setting-right-title">
				              <div class="row">
				                <div class="col-lg-6">
				                  Standard-Berechtigungen der Organisation
				                </div>
				                <div class="col-lg-6 text-right">
				                  <ul class="nutzer-top">
				                    <li><Link to="datenfreigabe-bearbeiten" class="btn-theme btn-sm">Datenfreigabe bearbeiten</Link></li>
				                  </ul>
				                </div>
				              </div>

				            </div>
				            <div class="Setting-right-content bt1px">
				              <div class="p20">
				                <table class="table table-bordered DatenfreigabeTable">
				                  <thead>
				                    <tr>
				                      <th scope="col">Modul</th>
				                      <th scope="col">Standard Zugang </th>
				                      <th scope="col"></th>
				                    </tr>
				                  </thead>
				                  <tbody>
				                    <tr>
				                      <td>Tickets</td>
				                      <td>Öffentliche lesen/Schreiben/löschen </td>
				                      <td><Link to="datenfreigabe-bearbeiten" class="hoverShow"><i class="lnr lnr-pencil"></i></Link></td>
				                    </tr>
				                    <tr>
				                      <td>Kontakte</td>
				                      <td>Öffentliche lesen/Schreiben/löschen</td>
...
export default StandardBerechtigungen 
