							    ...
							    <div className="row">
							      ...
							      <div className="col-lg-6 text-right">
							        <ul className="nutzer-top">
							          <li><Link className="btn-theme btn-sm">Editieren</Link></li>
							        </ul>
							      </div>
							    </div>
							  </div>
							      ...
							      <div className="col-lg-12">
							        <div className="company_bdrshadow">
							          <div className="media p20">
							            <img className="mr-3" src="images/company_logobg.jpg" alt="company_logo" />
							                ...
							                <div className="row">
							                  <div className="col-md-6">
							                    <div className="form-group">
							                      ...
							                      <div><Link>oneixswiss@gmail.com</Link></div>
							                    </div>
							                  </div>
							                  <div className="col-md-6">
							                    <div className="form-group">
