...
export class Nebenagent  extends Component{
    render(){
        return(
            <div>
                <Header />
		                ...
		                <div className="setting-right">
							  ...
							  <div className="Setting-right-content bt1px">
							    <div className="profile-setting-scroll">
							      <div className="p20">
							        <div className="mb-4">
							          <h2 className="mb-0">Nebenagent</h2>
							          <p>Berechtigung für Nebenagenten festlegen</p>
							        </div>
							        <div className="row">
							              ...
							              <ul>
							                <li>
							                  <div className="pleft">
							                    ...
							                    <span className="content-dotted">Nur anzeigen</span>
							                  </div>
