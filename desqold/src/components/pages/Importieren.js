								                ...
								                <div className="col-md-4">
								                  <div className="form-group">
								                    ...
								                    <select name id className="form-control chosen-select">
								                      <option value>Kontos importieren</option>
								                      <option value>Kontakte importieren</option>
								                      <option value>Aufgaben importieren</option>
								                      <option value>Anrufe importieren</option>
								                      <option value>Ereignisse importieren</option>
								                      <option value>Produkte importieren</option>
								                      <option value>Tickets importieren</option>
								                      <option value>Hilfecenter importieren</option>
								                    </select>
								                  </div>
								                </div>
								              </div>
								              <div className="row mt-4">
								                <div className="col-md-6">
								                  <div className="form-group">
								                    ...
								                    <div className="mt-3">
								                      <Link className="link-blue mr-3 rndbtn" style={{transform: 'rotate(-45deg)'}}>
								        ...
								        <TabPanel>
								          <div className="p20">
								            <table className="table table-bordered">
								              <thead>
								                <tr>
								                  <th className="text-center" width="10%"><label className="ix-checkbox-label">
								                      <input type="checkbox" className="ix-checkbox" /><mark className /></label>
								                  </th>
								                  <th width="20%">Name</th>
								                  <th width="15%">Typ</th>
								                  <th width="40%">Gelöscht von</th>
								                  <th width="15%">Gelöscht Zeit</th>
								                </tr>
								              </thead>
								              <tbody>
								                <tr>
								                  <td colSpan={5} className="text-center" width="10%">
