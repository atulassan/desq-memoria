...
export class GeneralSettingsKontakte  extends Component{
    render(){
        return(
            <div>
                <Header />
						    ...
						    <div className="row">
						      <div className="col-lg-12">
						        <div className="Weitere-Konfiguration">
						          <ul>
						            <li>
						              <h5>Automatic Spam Detection
						                <label className="switch mt-3 switch-pos">
						                  <input type="checkbox" />
						                  <span className="slider round" />
						                </label>
						              </h5>
						              <p className="w-60">If this feature is enabled, Zoho Desk will scan all incoming Tickets and automatically mark the ones that meet certain predefined conditions as spam. Tickets and Kontakte associated with spam emails are displayed only in the Spam Tickets and Spam Kontakte views. Kontakte marked as spam do not get access to your help center.</p>
						              <div className="mt-3">
						                <label className="ix-checkbox-label">
						                  <input type="checkbox" className="ix-checkbox" /><mark className /> 
						                  <span className="ml-2">Do not auto-mark the kontakt as spam if other valid tickets are already associated with it.</span>
						                </label>
						              </div>
						            </li>
						          </ul>
...
export default GeneralSettingsKontakte 
