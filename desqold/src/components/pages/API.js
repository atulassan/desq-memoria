							    ...
							    <div className="row">
							      <div className="col-lg-12">
							        <div className="p20">
							          ...
							          <p className="api-hilight"><Link className="link-blue">https://desk.zoho.eu/support/APIDocument.do#OauthTokens</Link></p>
							          <p>To manage all the apps authenticated using OAuth, <Link className="link-blue"> klicken Sie hier</Link></p>
