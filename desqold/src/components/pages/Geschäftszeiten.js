							    ...
							    <div className="row">
							      ...
							      <div className="col-lg-6 text-right">
							        <ul className="nutzer-top">
							          <li><a href className="btn-theme btn-sm">New Business Hour</a></li>
							        </ul>
							      </div>
							    </div>
							  </div>
								            ...
								            <div className="row">
								              <div className="col-lg-12">
								                <div className="no-feeds mt-4 w60">
								                  <div className="mb-3">
								                    <img src="images/geschäftszeiten.jpg" alt="geschäftszeiten" />
								                  </div>
								        ...
								        <TabPanel>
								            <div className="row">
								              <div className="col-lg-12">
								                <div className="no-feeds mt-4 w60">
								                  <div className="mb-3">
								                    <img src="images/geschäftszeiten1.jpg" alt="geschäftszeiten" />
								                  </div>
