		                ...
		                <div className="setting-right">
							  ...
							  <div className="Setting-right-content bt1px">
							    <div className="profile-setting-scroll">
							      <div className="p20">
							        <div className="mb-4">
							          <div className="profileNameBase"><h2 className="mb-0">Supervisor <Link className="hoverShow"><i className="lnr lnr-pencil" /></Link></h2></div>
							          <div id="profileNameEdit" className="mb-2" style={{display: 'none'}}>
							            <form>
							              <div className="form-row align-items-center">
							                <div className="col-auto">
							                  <input type="text" className="form-control" id defaultValue="Supervisor" />
							                </div>
							                <div className="col-auto">
							                    ...
							                    <span className="dropdown">
							                      ...
							                      <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
							                        ...
							                        <div className="drop_btns">
							                          ...
							                          <button className="btn-theme btn-xs">Stornieren</button>
							                        </div>
							                      </div>
							                    </span>
							                  </div>
							                  ...
							                  <div className="pleft">
							                    ...
							                    <span className="dropdown">
							                      ...
							                      <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
							                        ...
							                        <div className="drop_btns">
							                          <button className="btn-theme btn-xs mr-1">Speichern</button>
							                          <button className="btn-theme btn-xs">Abbrechen</button>
							                        </div>
							                      </div>
							                    </span>
							                  </div>
