		                ...
		                <div className="setting-right">
						  ...
						  <div className="Setting-right-content">
						    <table className="table m-0 Ticket-Status">
						      <thead>
						        <tr>
						          <th className="text-center" width="10%"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" /><mark className /></label></th>
						          <th width="50%">Name</th>
						          <th className="text-center" width="20%">Kontakt im Hilfecenter anzeigen </th>
						          <th width="20%" />
						        </tr>
						      </thead>
						      <tbody>
						        <tr>
						          <td className="text-center" width="10%"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" /><mark className /></label></td>
						          <td width="50%">
						          	<Link to="ticket-vorlage-bearbeiten" className="link-blue">Sar</Link>
						          </td>
						          <td className="text-center" width="20%">
						          	<label className="ix-radiobox-label"><input type="checkbox" className="ix-radiobox" /><mark className /></label>
						          </td>
						          <td className="text-center" width="20%">
