							        ...
							        <Tabs>
								                      ...
								                      <div className="row">
								                        ...
								                        <div className="col-md-12">
								                          <div className="form-group">
								                            ...
								                            <input type="file" className="form-control" placeholder style={{border: '0px'}} />
								                          </div>
								                        </div>
								          ...
								          <TabPanel>
								            <div className="ticketcolum_right_scroll">
								              <div className="row">
								                <div className="col-md-12">
								                  <div className="p20">Domänenzuordnung | Schließen Sie <Link className="link-blue">Domänenverknüpfung</Link> zum Einrichten der externen Authentifizierung ab.</div>
								                </div>
								              </div>
								            </div>
								          </TabPanel>
