...
export class ModuleOrganisieren extends Component{
    render(){
        return(
            <div>
                <Header />
							      ...
							      <div className="col-lg-12">
							        <div className="row">
							          <div className="col-lg-8 ">
							            <div className="mdule-organisieren-left br1px">
							              <div className="p20">
							                <div className="organisieren-left-title">
							                  <img src="images/svg/move.svg" alt="move" /> Zum Ändern der Reihenfolge ziehen
							                </div>
							                <div className="organisieren-list">
							                  <ul>
							                    ...
							                    <li><span><img src="images/svg/dial.svg" alt="dial" /></span>Community</li>
							                    <li><span><img src="images/svg/dial.svg" alt="dial" /></span>Kunden</li>
							                    <li><span><img src="images/svg/dial.svg" alt="dial" /></span>Berichte</li>
							                    <li><span><img src="images/svg/dial.svg" alt="dial" /></span>Aktivitäten</li>
							                    <li><span><img src="images/svg/dial.svg" alt="dial" /></span>Sozial</li>
							                    <li><span><img src="images/svg/dial.svg" alt="dial" /></span>Chat</li>
							                  </ul>
							                </div>
							              </div>
							            </div>
							          ...
							          <div className="col-lg-4">
							            <div className="mdule-organisieren-right">
							              <div className="p20">
							                <div className="organisieren-right-title">
							                  Nicht gewählte Module
							                </div>
							                <div className="organisieren-right-img">
							                  <img src="images/gewählte-module.jpg" alt="gewählte" />
							                  <p>Zum Entfernen hierher ziehen</p>
							                </div>
							              </div>
							            </div>
							          </div>
...
export default ModuleOrganisieren
