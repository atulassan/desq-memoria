...
export class ValidationRules extends Component{
    render(){
        return(
            <div>
                <Header />
						    ...
						    <div className="row">
						      <div className="col-lg-12">
						        <div className="no-feeds mt-4 w60">
						          ...
						          <h1>No layout rules here.</h1>
						          <p>Add a layout rule to control the order in which fields are presented to users.</p>
						        </div>
						      </div>
						    </div>
						  </div>
