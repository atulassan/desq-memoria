...
export class Felderliste extends Component{
    render(){
        return(
            <div>
                <Header />
		               ...
		               <div className="setting-right">
						    ...
						    <div className="row">
						        ...
						        <span className="dropdown">
						          ...
						          <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
						            ...
						            <div className="dropMinHeight">
						              <Link  href className="dropdown-item">Tickets</Link>
						              <Link  href className="dropdown-item">Accounts</Link>
						              <Link  href className="dropdown-item">Contacts</Link>
						              <Link  href className="dropdown-item">Products</Link>
						              <Link  href className="dropdown-item">Time Entry</Link>
						              <Link  href className="dropdown-item">Contracts</Link>
						              <Link  href className="dropdown-item">Calls</Link>
						              <Link  href className="dropdown-item">Tasks</Link>
						              <Link  href className="dropdown-item">Events</Link>
						            </div>
						          </div>
						        </span>
						      </div>
						      <div className="col-lg-6 text-right">
						        <ul className="nutzer-top">
						          <li><input type name placeholder="Felder oder Datentypen suchen..." /></li>
						          <li><Link  href className="btn-theme btn-sm">Felder erstellen oder bearbeiten</Link></li>
						        </ul>
						      </div>
						    </div>
						  </div>
						  <div className="Setting-right-content">
						    <table className="table m-0">
						      <thead>
						        <tr>
						          <th className="text-left pl-3" width="20%">FELDNAME</th>
						          <th className="text-left" width="20%">DATENTYP</th>
						          <th className="text-left" width="20%">API NAME</th>
						        </tr>
						      </thead>
						      <tbody>
						        <tr>
						          <td className="text-left pl-3"><strong>Konto Name</strong></td>
						          <td className="text-left">Nachschlagen</td>
						          <td className="text-left">accountId</td>
						        </tr>
						        <tr>
						          <td className="text-left pl-3"><strong>Kategorie</strong></td>
						          <td className="text-left">Auswahlliste</td>
						          <td className="text-left">category</td>
						        </tr>
						        <tr>
						          <td className="text-left pl-3"><strong>Kanal</strong></td>
						          <td className="text-left">Auswahlliste</td>
						          <td className="text-left">channel</td>
						        </tr>
						        <tr>
						          <td className="text-left pl-3"><strong>Klassifizierungen</strong></td>
						          <td className="text-left">Auswahlliste</td>
						          <td className="text-left">classification</td>
						        </tr>
						        <tr>
						          <td className="text-left pl-3"><strong>Konto Name</strong></td>
						          <td className="text-left">Nachschlagen</td>
						        ...
						        <tr>
						          <td className="text-left pl-3"><strong>Abteilung</strong></td>
						          <td className="text-left">Nachschlagen</td>
						          <td className="text-left">departmentId</td>
						        </tr>
						        <tr>
						          <td className="text-left pl-3"><strong>Beschreibung</strong></td>
						          <td className="text-left">Mehrzeilig</td>
						          <td className="text-left">description</td>
						        </tr>
						        <tr>
						          <td className="text-left pl-3"><strong>Fälligkeitsdatum</strong></td>
						          <td className="text-left">Datum/Uhrzeit</td>
						          <td className="text-left">dueDate</td>
						        </tr>
						        <tr>
						          <td className="text-left pl-3"><strong>E-Mail</strong></td>
						          <td className="text-left">E-Mail</td>
						          <td className="text-left">email</td>
						        </tr>
						        <tr>
						          <td className="text-left pl-3"><strong>Tel.</strong></td>
						          <td className="text-left">Tel.</td>
						          <td className="text-left">phone</td>
						        </tr>
						        <tr>
						          <td className="text-left pl-3"><strong>Priorität</strong></td>
						          <td className="text-left">Auswahlliste</td>
						          <td className="text-left">priority</td>
						        </tr>
						        <tr>
						          <td className="text-left pl-3"><strong>Produkt Name</strong></td>
						          <td className="text-left">Nachschlagen </td>
						          <td className="text-left">productId</td>
						        </tr>
						        <tr>
						          <td className="text-left pl-3"><strong>Lösung</strong></td>
						          <td className="text-left">Mehrzeilig </td>
						          <td className="text-left">resolution</td>
						        </tr>
						        <tr>
						          <td className="text-left pl-3"><strong>Status</strong></td>
						          <td className="text-left">Auswahlliste </td>
						          <td className="text-left">status</td>
						        </tr>
						        <tr>
						          <td className="text-left pl-3"><strong>Unterkategorie</strong></td>
						          <td className="text-left">Auswahlliste </td>
						          <td className="text-left">subCategory</td>
						        </tr>
						        <tr>
						          <td className="text-left pl-3"><strong>Betreff</strong></td>
						          <td className="text-left">Einzelzeile</td>
						          <td className="text-left">subject</td>
						        </tr>
						        <tr>
						          <td className="text-left pl-3"><strong>Ticket Besitzer</strong></td>
						          <td className="text-left">Nachschlagen</td>
						          <td className="text-left">assigneeId</td>
						        </tr>
						      </tbody>
						    </table>
						  </div>
