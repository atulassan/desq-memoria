					             	...
					             	<div className="row">
						              <div className="col-md-12">
						                ...
						                <ul className="timeline">
						                  <li>
						                    <Link target href>#102 Test</Link>
					                ...
					                <div className="ticket_contact_info_scroll">
					                  ...
					                  <div className="overAllRslt">
					                    <ul>
					                      ...
					                      <li>
					                        <div className="tktBase">
					                          <p><img src="images/emoji-smile.png" alt="emoji-smile" /> 0% <span>Zufriedenheitsbewertung</span></p>
					                        </div>
					                      </li>
					                    </ul>
					                  </div>
					                    ...
					                    <div className="row">
					                      <div className="col-lg-6">
					                        <div className="ratingTopLeft">
					                          ...
					                          <span><img src="images/emoji-smile.png" alt="emoji-smile" /></span> 
