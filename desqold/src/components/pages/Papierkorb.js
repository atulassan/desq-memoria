		                ...
		                <div className="setting-right">
							  <div className="setting-right-title">
							    Papierkorb <span className="dropdown">
							      <Link id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							        Alle(s) <i className="lnr lnr-chevron-down" />
							      </Link>
							      <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
							        <Link className="dropdown-item drop_title">Modul</Link>
							        <span className="dropSearch"><input type="text" placeholder="Suchen" /></span>
							        <div className="dropMinHeight">
							          <Link className="dropdown-item">Alle(s)</Link>
							          <Link className="dropdown-item">Verträge</Link>
