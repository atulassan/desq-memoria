...
export class WeitereKonfiguration extends Component{
    render(){
        return(
            <div>
                <Header />
		                      ...
		                      <div className="setting-left-accordion">
		                        <div className="accordion" id="accordion">
		                          ...
		                          <div className="card">
		                            ...
		                            <div id="collapse1" className="collapsed" aria-labelledby="heading1" data-parent="#accordion">
						    ...
						    <div className="row">
						      <div className="col-lg-12">
						        <div className="Weitere-Konfiguration">
						          <ul>
						            <li>
						              <h5>Automatisches CC für E-Mail-Antworten an Ihr Supportpostfach 
						                <label className="switch mt-3 switch-pos">
						                  <input type="checkbox" />
						                  <span className="slider round" />
						                </label>
						              </h5>
						              <p>Versenden Sie automatisch Kopien (CC) sämtlicher von Ihnen gesendeter E-Mails an Ihren Kundendienst-Posteingang.</p>
						            </li>
						            <li>
						              <h5>Kontakte mit der „Antwort an“-E-Mail-Adresse erstellen
						                <label className="switch mt-3 switch-pos">
						                  <input type="checkbox" />
						                  <span className="slider round" />
						                </label>
						              </h5>
						              <p>Die „Antwort an“-Adresse bei E-Mails wird zum Erstellen von Kundenkontakten verwendet. Wenn deaktiviert, werden Kontakte aus der Absenderadresse erstellt.</p>
						            </li>
						            <li>
						              <h5>Agentenname in Ticketantworten an Kunden anzeigen
						                <label className="switch mt-3 switch-pos">
						                  <input type="checkbox" />
						                  <span className="slider round" />
						                </label>
						              </h5>
						              <p>Der Name des Agenten (Vor- und Nachname) wird in Ticketantworten gemeinsam mit dem Kundendienst-E-Mail-Alias angezeigt. Wenn deaktiviert, wird nur der lesefreundliche Name des Alias angezeigt.</p>
						            </li>
						            <li>
						              <h5>Bei E-Mail-Weiterleitung Tickets im Namen des Absenders erstellen
						                <label className="switch mt-3 switch-pos">
						                  <input type="checkbox" />
						                  <span className="slider round" />
						                </label>
						              </h5>
						              <p>Wenn Agenten E-Mails an Ihren Kundendienst-Posteingang weiterleiten, wird dadurch ein Ticket im Namen des Absenders erstellt. Wenn deaktiviert, wird der Agent als Kontakt behandelt.</p>
						              <div className="wk-note">
						                <div className="row">
						                  <div className="col-lg-6">
						                    <p><strong>Wichtig:</strong></p>
						                    <p>Bei weitergeleiteten E-Mails müssen Agenten das Schlüsselwort „#original_sender“ gefolgt von der E-Mail-Adresse des Kunden ganz oben in den E-Mail-Inhalt einfügen.</p>
						                  </div>
						                  <div className="col-lg-6 text-center">
						                    <p><strong>#original_sender{'{'} <span className="blue-link"> sender_email</span>{'}'}</strong></p>
						                    <p>Beispiel: #original_sender {'{'}customer@emailaddress.com{'}'}</p>
						                  </div>
						                </div>
						              </div>
						            </li>
						            <li>
						              <h5>Ticket-Threads gemäß Empfängern automatisch als privat festlegen.
						                <label className="switch mt-3 switch-pos">
						                  <input type="checkbox" />
						                  <span className="slider round" />
						                </label>
						              </h5>
						              <p>Beim Antworten auf Tickets werden Threads automatisch auf privat eingestellt, wenn es sich beim Anfrager nicht um den Empfänger handelt. Agenten können diese jedoch bei Bedarf auf öffentlich einstellen.</p>
						              <p className="mt-3"><i className="fa fa-diamond mr-2" aria-hidden="true" /> Weitergeleitete Threads werden ungeachtet dieser Einstellung grundsätzlich als privat markiert.</p>
						            </li>
						          </ul>
						        </div>
						      </div>
...
export default WeitereKonfiguration
