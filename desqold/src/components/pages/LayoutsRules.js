...
export class LayoutsRules extends Component{
    render(){
        return(
            <div>
                <Header />
						    ...
						    <div className="row">
						      ...
						      <div className="col-lg-6 text-right">
						        <ul className="nutzer-top">
						          <li><Link className="btn-theme btn-sm">Create Rule</Link></li>
						        </ul>
						      </div>
						    </div>
						  </div>
						    ...
						    <div className="row">
						      <div className="col-lg-12">
						        <div className="no-feeds mt-4 w60">
						          <div className="mb-3">
						            <img src="images/layout-rules.jpg" alt="layout-rules" />
						          </div>
						          <h1>No validation rules here.</h1>
						          <p>Add a validation rule to verify data an agent enters within a record before saving it.</p>
						        </div>
						      </div>
						    </div>
						  </div>
