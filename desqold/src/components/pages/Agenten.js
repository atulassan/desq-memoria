...
export class Agenten  extends Component{
    render(){
        return(
            <div>
                <Header />
						    ...
						    <div className="row">
						      ...
						      <div className="col-lg-6 text-right">
						        <ul className="nutzer-top">
						          <li><input type name placeholder="Nutzer suchen …" /></li>
						          <li><Link to="agentendaten-bearbeiten" className="btn-theme btn-sm">Neuer Techniker</Link></li>
						        </ul>
						      </div>
						    </div>
						  </div>
						  <div className="Setting-right-content">
						    <div className="row">
						      <div className="col-lg-12">
						        <Tabs>
			                      <TabList>
			                        <Tab>Aktive Agenten (1)</Tab>
			                        <Tab>Deaktivierte Agenten (0)</Tab>
			                        <Tab>Nicht bestätigt (0)</Tab>
			                        <Tab>Alle Agenten (1)</Tab>
			                        <Tab>Gelöschte Techniker</Tab>
			                        <Tab>Light Agents (0)</Tab>
			                      </TabList>
						          <TabPanel>
						            <div className="p20">
						              <ul className="AgentenList">
						                <li className="media">
						                  <div className="mediaImg font13">AS <span className="PrmryTxt">PRIMÄR</span></div>
						                  <div className="media-body">
						                    <h5 className="mt-0 hint-title smTitle mt-2 mb-0">
						                      <span className="agenten-title truncate-ellipsis">anitha Sivakumar</span> 
						                      <Link to="agentendaten-bearbeiten" className="agent-edit"><i className="lnr lnr-pencil" /></Link>
						                    </h5>
						                    <span>oneixswiss@gmail.com</span>
						                    <span>CEO Kundendienstadministrator</span>
						                  </div>
						                </li>
						              </ul>
						            </div>
						          ...
						          <TabPanel>
						            <div className="no-feeds mt-4">
						              <h1>Keine Agenten in der Liste.</h1>
						            </div>
						          </TabPanel>
						          <TabPanel>
						            <div className="no-feeds mt-4">
