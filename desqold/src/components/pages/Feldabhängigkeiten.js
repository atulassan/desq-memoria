...
export class Feldabhängigkeiten extends Component{
    render(){
        return(
            <div>
                <Header />
						    ...
						    <div className="row">
						      ...
						      <div className="col-lg-6 text-right">
						        <ul className="nutzer-top">
						          <li><Link  className="btn-theme btn-sm">Neue Abhängigkeit hinzufügen</Link></li>
						        </ul>
						      </div>
						    </div>
						  </div>
						  <div className="Setting-right-content">
						    <table className="table m-0a Ticket-Status">
						      <thead>
						        <tr>
						          <th className="text-left pl-3" width="20%">HAUPTFELD</th>
						          <th className="text-left pl-3" width="20%">UNTERFELD</th>
						          <th className="text-left pl-3" width="20%" />
						        </tr>
						      </thead>
						      <tbody>
						        <tr className="move">
						          <td className="text-left pl-3">KATEGORIE</td>
						          <td className="text-left pl-3">UNTERKATEGORIE</td>
						          <td className="text-left pl-3">
						            <Link  className="hoverShow"> <i className="lnr lnr-trash" /></Link>
						          </td>
						        </tr>
						      </tbody>
						    </table>
...
export default Feldabhängigkeiten
