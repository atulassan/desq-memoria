...
export class PortalnamenAndern extends Component{
    render(){
        return(
            <div>
                <Header />
						            ...
						            <div className="row">
						              <div className="col-md-12">
						                <div className="form-group mb-5">
						                  <label>Portalnamen eingeben</label>
						                  <p>https://desk.oneix.eu/support/ <input type="tex" className defaultValue="oneixgmbh377" /> </p>
						                </div>
						              </div>
						            </div>
						          </form>
...
export default PortalnamenAndern
