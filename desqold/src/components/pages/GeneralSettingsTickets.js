...
export class GeneralSettingsTickets  extends Component{
    render(){
        return(
            <div>
                <Header />
		                      ...
		                      <div className="setting-left-accordion">
		                        <div className="accordion" id="accordion">
		                          ...
		                          <div className="card">
		                            ...
		                            <div id="collapse15" className="collapsed" aria-labelledby="heading15" data-parent="#accordion">
		                              <div className="card-body">
		                                <ul>
		                                  <li class="active">
							      ...
							      <div className="col-lg-12">
							        ...
							        <span className="dropdown">
							          <Link id="dropdownMenuButton" data-toggle="dropdown">
							            one ix gmbh <i style={{position: 'relative', left: '5px', top: '1px'}} className="lnr lnr-chevron-down" />
							          </Link>
							          <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
							            <div className="dropMinHeight">
							              <Link className="dropdown-item drop_title">ABTEILUNGEN</Link>
							              <Link className="dropdown-item">one ix gmbh</Link>
							            </div>
							          </div>
							        </span>
							      </div>
							    ...
							    <div className="row">
							      <div className="col-lg-12">
							        <div className="Weitere-Konfiguration">
							          <ul>
							            <li>
							              <h5>CCs bei tickets zulassen
							                <label className="switch mt-3 switch-pos">
							                  <input type="checkbox" />
							                  <span className="slider round" />
							                </label>
							              </h5>
							              <p className="w-60">Die CC-Funktion ermöglicht Ihren Agenten und Endanwendern, zusätzliche Anfrager zu ticket hinzuzufügen. Agenten können andere Personen in E-Mail-Antworten, auf der ticket-Detailseite und dem ticket-hinzufügen-Formular hinzufügen. Endanwender können andere Anfrager in E-Mail oder Hilfecenter kopieren. CC-Anfrager erhalten E-Mail-Benachrichtigungen bei sämtlichen tickets-Aktionen.</p>
							            </li>
							            <li>
							              <h5>Send as Email
							                <label className="switch mt-3 switch-pos">
							              ...
							              <p className="w-60">Agents can send outbound emails to new or existing contacts, convert them into tickets, and track their progress. Besides, such contacts do not receive the new ticket notification. <a href className="link-blue">Mehr dazu</a></p>
							            </li>
							          </ul>
							        </div>
							      </div>
...
export default GeneralSettingsTickets 
