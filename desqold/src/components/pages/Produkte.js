						    ...
						    <div className="row">
						      ...
						      <div className="col-lg-6 text-right">
						        <ul className="nutzer-top">
						          <li><a href className="btn-theme btn-sm">Neue Produkt</a></li>
						        </ul>
						      </div>
						    </div>
						  </div>
						          ...
						          <span className="dropdown">
						            ...
						            <div className="dropdown-menu posLeft" aria-labelledby="dropdownMenuButton">
						              <div className="dropMinHeight">
						                <a href className="dropdown-item">Alle Produkte</a>
						                <a href className="dropdown-item">Meine Produkte</a>
						              </div>
						              <a className="link text-center drop-btn" href><i style={{position: 'relative', top: '1px', marginRight: '5px'}} className="lnr lnr-plus-circle" /> Neue Ansicht erstellen</a>
						            </div>
						          </span>
						        </div>
						      </div>
