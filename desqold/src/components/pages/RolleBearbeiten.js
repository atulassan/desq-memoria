...
export class RolleBearbeiten  extends Component{
    render(){
        return(
            <div>
                <Header />
							                ...
							                <div className="row">
							                  <div className="col-md-12">
							                    <div className="form-group">
							                      <label className="label-red">Funktionsname</label>
							                      <input type="text" className="form-control" placeholder defaultValue="Manager" />
							                    </div>
							                  </div>
							                  <div className="col-md-12">
							                    <div className="form-group">
							                      <label>Berichterstattungspflichtig an</label>
							                      <div className="input-group">
							                        <input type="text" className="form-control" placeholder defaultValue="CEO" />
							                        <div className="input-group-append">
							                          <span style={{paddingTop: '10px'}} id="basic-addon"><span className="mr-1"><i className="lnr-file-add" /></span> <span style={{border: '1px solid #ddd', padding: '0px 3px', height: '10px', lineHeight: 0}}>×</span></span>
							                        </div>
							                      </div>
							                    </div>
							                  </div>
							                  ...
							                  <div className="col-md-12">
							                    <div className="form-group">
							                      ...
							                      <textarea className="form-control" placeholder defaultValue={"Die zugehörigen Agenten können jedoch keine Daten von Nutzern mit Administratorrollen einsehen"} />
							                    </div>
							                  </div>
							                </div>
							              </div>
...
export default RolleBearbeiten 
