					  ...
					  <div className="mainWrapperBody">
		                ...
		                <div className="setting-right">
							  <div className="setting-right-title">
							    Absenderadresse <span className="float-right"><Link  className="btn-theme btn-sm">Neue Absenderadresse</Link></span>
							  </div>
							  <div className="Setting-right-content">
							    <table className="table m-0">
							      <thead>
							        <tr>
							          <th className="text-center" width="20%">ABSENDERADRESSE</th>
							          <th className="text-center" width="20%">LESEFREUNDLICHER NAME</th>
							          <th className="text-center" width="20%">ÜBERPRÜFUNGSSTATUS</th>
							          <th className="text-center" width="20%">ALLE STATUS</th>
							          <th className="text-center" width="20%" />
							        </tr>
							      </thead>
							      <tbody>
							        <tr>
							          <td className="text-center"><div className="hlpcnt"><Link  className="link-blue">support@oneixgmbh377.oneix.ch</Link></div></td>
							          ...
							          <td className="text-center">
							            <span className="dropdown">
							              <Link className="btn " type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
							                <i className="fa fa-ellipsis-h" />
							              </Link>
							              <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
							                <Link  className="dropdown-item">Editieren</Link>
							                <Link  className="dropdown-item">Löschen</Link>
							              </div>
							            </span>
							          </td>
							        </tr>
