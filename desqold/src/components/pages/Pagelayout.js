		               ...
		               <div className="setting-right">
						  ...
						  <div className="Setting-right-content">
						    <table className="table m-0">
						      <thead>
						        <tr>
						          <th className="text-center" width="25%">NAME</th>
						          <th className="text-center" width="25%">PROFILE</th>
						          <th className="text-center" width="25%">IM HILFECENTER ANZEIGEN</th>
						          <th className="text-center" width="25%">
						            <span className="dropdown">
						              ...
						              <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
						                ...
						                <Link  className="dropdown-item ">Aktiv</Link>
						                <Link  className="dropdown-item ">Inaktiv</Link>
						              </div>
						            </span>
						          </th>
						        </tr>
						      ...
						      <tbody>
						        <tr>
						          ...
						          <td className="text-center">
						            <img src="images/svg/checkmark-green.svg" style={{width: '15px'}} alt="checkmark" />
						          </td>
						          <td className="text-center">
