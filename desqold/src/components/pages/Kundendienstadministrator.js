...
export class Kundendienstadministrator  extends Component{
    render(){
        return(
            <div>
                <Header />
		                ...
		                <div className="setting-right">
							  ...
							  <div className="Setting-right-content bt1px">
							    <div className="profile-setting-scroll">
							      <div className="p20">
							        <div className="mb-4">
							          <h2 className="mb-0">Kundendienstadministrator</h2>
							          <p>Legen Sie Berechtigungen für Kundendienstadministratoren fest.</p>
							        </div>
							        <div className="row">
							                ...
							                <li>
							                  <div className="pleft">
							                    ...
							                    <span className="dropdown">
							                      <Link id="dropdownMenuButton" data-toggle="dropdown" >
							                        <i className="lnr lnr-chevron-down" />
							                      </Link>
							                      <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
							                        <Link className="dropdown-item">
							                          <label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />Ansicht</label>
							                        </Link>
							                        <Link className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />Erstellen</label></Link>
							                        <Link className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />Aktualisieren</label></Link>
							                        <Link className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />Löschen</label></Link>
							                        <div className="drop_btns">
							                          <button className="btn-theme btn-xs mr-1">Speichern</button>
							                          <button className="btn-theme btn-xs mr-1">Stornieren</button>
							                        </div>
							                      </div>
							                    </span>
							                  </div>
							              ...
							              <ul>
							                <li>
							                  <div className="pleft">
							                    ...
							                    <span className="content-dotted">Bearbeiten, Löschen</span>
							                    <span className="dropdown">
							                      <Link id="dropdownMenuButton" data-toggle="dropdown" >
							                        <i className="lnr lnr-chevron-down" />
							                      </Link>
							                      <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
							                        <Link className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />Bearbeiten</label></Link>
							                        <Link className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />Löschen</label></Link>
							                        <div className="drop_btns">
							                          <button className="btn-theme btn-xs mr-1">Speichern</button>
							                ...
							                <li>
							                  <div className="pleft">
							                    ...
							                    <span className="content-dotted">E-Mail, Hilfecenter, Community, Chat, Soziales, Telefonie, Webformular</span>
							                    <span className="dropdown">
							                      <Link id="dropdownMenuButton" data-toggle="dropdown" >
							                        <i className="lnr lnr-chevron-down" />
							                      </Link>
							                      <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
							                        <Link className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />E-Mail</label></Link>
							                        <Link className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />Hilfecenter</label></Link>
							                        <Link className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />Community</label></Link>
							                        <Link className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />Chat</label></Link>
							                        <Link className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />Soziales</label></Link>
							                        <Link className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />Telefonie</label></Link>
							                        <Link className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />Webformular</label></Link>
							                        <div className="drop_btns">
							                          <button className="btn-theme btn-xs mr-1">Speichern</button>
							                          <Link to className="btn-theme btn-sm">Abbrechen</Link>
							                        </div>
							                ...
							                <li>
							                  <div className="pleft">
							                    ...
							                    <span className="dropdown">
							                      ...
							                      <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
							                        <Link className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />Tickets</label></Link>
							                        <Link className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />Kontos</label></Link>
							                        <Link className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />Kontakte</label></Link>
							                        <Link className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />Hilfecenter</label></Link>
							                        <Link className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />Aufgaben</label></Link>
							                        <Link className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />Calls</label></Link>
							                        <Link className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />Events</label></Link>
							                        <Link className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />Produkte</label></Link>
							                        <Link className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />Verlauf</label></Link>
							                        <div className="drop_btns">
							                          <button className="btn-theme btn-xs mr-1">Speichern</button>
							                          <Link to className="btn-theme btn-sm">Abbrechen</Link>
							                        </div>
							                  ...
							                  <div className="pleft">
							                    ...
							                    <span className="dropdown">
							                      ...
							                      <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
							                        ...
							                        <Link className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />Events</label></Link>
							                        <Link className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />Produkte</label></Link>
							                        <Link className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />Agenten</label></Link>
							                        <Link className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />Endnutzer</label></Link>
							                        <Link className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />Berichte</label></Link>
							                        <div className="drop_btns">
							                          <button className="btn-theme btn-xs mr-1">Speichern</button>
							                          <Link to className="btn-theme btn-sm">Abbrechen</Link>
							                        </div>
...
export default Kundendienstadministrator 
