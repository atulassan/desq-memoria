							            ...
							            <div className="col-lg-4">
							              ...
							              <div className="form-group">
							                <div className="mb-3 zeiterfassung-label">
							                  ...
							                  <div>
							                    <label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" defaultChecked name /><mark className="mr-2" />
							                      Anrufe</label>
							                  </div>
							                </div>
							              </div>
							              ...
							              <div className="mt-3">
							                <label className="ix-checkbox-label">
							                  <input type="checkbox" className="ix-checkbox" name /><mark className="mr-2" />Timer für ein(e) aktivität auf einmal starten.</label>
							              </div>
							            </div>
							          </div>
							          <div className="row">
							            <div className="col-lg-12 zeiterfassung-height">
							              ...
							              <p><Link className="link-blue">Rechnungsverlauf</Link></p>                    
							            </div>
							          </div>
							        </div>
							      </div>
