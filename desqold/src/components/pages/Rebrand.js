						                  ...
						                  <ul>
						                    <li>
						                      ...
						                      <div className="brand-upload">
						                        <Link><i className="fa fa-camera" /></Link>
						                        <input type="file" name />
						                        <img src="images/fav-sample-icon.png" alt="fav-sample" />
						                      </div>
						                    </li>
						                    <li>
						                      <p>Favicon</p>
						            ...
						            <div className="row">
						              <div className="col-md-3">
						                ...
						                <div className="row">
						                  ...
						                  <div className="col-md-12">
						                    <div className="form-group">
						                      <Link className="blue-link"> desk.oneix.ch</Link> <span className="badge badge-warning ml-2">Primär</span>
						                    </div>
						                  </div>
						                </div>
						              </div>
