...
export class  PageSense extends Component{
    render(){
        return(
            <div>
                <Header />
							            ...
							            <div className="row">
							              <div className="col-md-12">
							                <div className="form-group">
							                  <h2>PageSense Integration</h2>
							                  <p>Bring the power of data analytics to your web forms and help center by integrating with oneix PageSense—the website optimization software. You can measure micro-interactions on web forms, create goals to track help center conversions, view page metrics, compare conversion rate across devices, and more.</p>
							                </div>
							              </div>
							              <div className="col-md-12">
							                <div className="form-group">
							                  <label className="ix-checkbox-label">
							                    <input type="checkbox" className="ix-checkbox" /><mark className="mr-2" /> Enabling PageSense Integration is considered as explicit consent given for collection, use, or disclosure of data.
							                  </label>
							                </div>
							              </div>
							              <div className="col-md-12">
							                <div className="form-group mt-3">
							                  <button className="btn-theme btn-md">Enable</button>
							                </div>
							              </div>
							            </div>
							          </form>
