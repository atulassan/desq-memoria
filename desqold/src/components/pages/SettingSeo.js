...
export class  SettingSeo  extends Component{
    render(){
        return(
            <div>
                <Header />
						              ...
						              <div className="col-md-12">
						                <div className="form-group">
						                  <label className="ix-checkbox-label">
						                    <input type="checkbox" className="ix-checkbox" /><mark className="mr-2" /> NOINDEX und NOFOLLOW
						                  </label>
						                </div>
						                <p>Verhindert die Aufnahme der Seite in den Index, verhindert auch, dass Bots den Links auf der Seite folgen.</p>
						              </div>
						            </div>
						          </form>
						        </div>
