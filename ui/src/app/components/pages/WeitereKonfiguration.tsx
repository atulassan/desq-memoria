						        ...
						        <div className="Weitere-Konfiguration">
						          <ul>
						            ...
						            <li>
						              ...
						              <p>Der des Agenten (Vor- und Nachname) wird in Ticketantworten gemeinsam mit dem Kundendienst-E-Mail-Alias angezeigt. Wenn deaktiviert, wird nur der lesefreundliche des Alias angezeigt.</p>
						            </li>
						            <li>
