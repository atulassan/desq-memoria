...
export class Jährliche extends Component{
    render(){
        return(
            <div>
							  ...
							  <div className="setting-right-title">
							    <div className="row">
							      <div className="col-lg-6">
							        Jährliche Liste arbeitsfreier Tage 
							      </div>
							      <div className="col-lg-6 text-right">
							        <ul className="nutzer-top">
							          <li><a data-href="#" className="btn-theme btn-sm">New Business List</a></li>
							        </ul>
							      </div>
							    </div>
							  </div>
								            ...
								            <div className="row">
								              <div className="col-lg-12">
								                <div className="no-feeds mt-4 w60">
								                  <div className="mb-3">
								                    <img src="/assets/images/Jährliche.jpg" alt="Jährliche" />
								                  </div>
								                  <h1>You haven't added any holiday lists yet</h1>
								                  <p>Click the button below to add your holidays so they will be treated as non-business hours</p>
								                  <div className=" mt-3 di-block"><button className="btn-theme btn-md">Add Business List</button></div>
								                </div>
								              </div>
								            </div>
							          	</TabPanel>
								            ...
								            <div className="row">
								              <div className="col-lg-12">
								                <div className="no-feeds mt-4 w60">
								                  ...
								                  <h1>There aren't any inactive holiday lists</h1>
								                  <p>Holiday lists that have been disabled in your account will be listed here</p>
								                </div>
								              </div>
								            </div>
								        </TabPanel>
