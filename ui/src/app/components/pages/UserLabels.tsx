...
export class UserLabels extends Component{
    render(){
        return(
            <div>
						    ...
						    <div className="row">
						      ...
						      <div className="col-lg-6 text-right">
						        <ul className="nutzer-top">
						          <li> <Link to="#" className="btn-theme btn-sm">Create label</Link></li>
						        </ul>
						      </div>
						    </div>
						  </div>
						    ...
						    <div className="row">
						      <div className="col-lg-12">
						        <div className="no-feeds mt-4 w60">
						          <div className="mb-3">
						            <img src="/assets/images/user-label.jpg" alt="user-label" />
						          </div>
						          <h1>Add your first label</h1>
						          <p>Labels are keywords or tags that you can add to end users to categorize or identify them in the help center. For example, you could add the label 'Expert' to users who've provided the best answers in the community.</p>
						          <div className=" mt-3 di-block"><a data-href="#" className="btn-theme">Create label</a></div>
						        </div>
						      </div>
						    </div>
						  </div>
