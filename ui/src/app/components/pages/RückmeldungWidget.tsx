...
export class  RückmeldungWidget  extends Component{
    render(){
        return(
            <div>
						    ...
						    <div className="row">
						      <div className="col-lg-12">
						        <div className="no-feeds mt-4 w60">
						          <div className="mb-3">
						            <img src="/assets/images/Rückmeldung-Widget.jpg" alt="Rückmeldung-Widget" />
						          </div>
						          <h1>Add your first label</h1>
						          <p>Rückmeldungen vereinfachen die Erfassung von Kundendienst-Tickets Ihrer Website zur Verarbeitung in Ihrem Helpdesk.</p>
						          <div className=" mt-3 di-block"><button  className="btn-theme btn-md">Rückmeldung-Widget erstellen</button></div>
						        </div>
						      </div>
						    </div>
						  </div>
...
export default  RückmeldungWidget 
