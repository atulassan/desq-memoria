...
export class KanaleEmail extends Component{
    render(){
        return(
            <div>
					  ...
					  <div className="mainWrapperBody">
					    ...
					    <div className="setting-right">
					      <div className="setting-right-title">
					        Kundendienst-E-Mail-Adresse <span className="float-right"> <Link to="#" className="btn-theme btn-sm">Neue Kundendienst-Mailadresse</Link></span>
					      </div>
					      <div className="Setting-right-content">
					        <table className="table m-0">
					          <thead>
					            <tr>
					              <th className="text-center" data-width="25%">KUNDENDIENST-E-MAIL-ADRESSE</th>
					              <th className="text-center" data-width="25%">LESEFREUNDLICHER NAME</th>
					              <th className="text-center" data-width="25%">E-MAIL-ABRUF</th>
					            ...
					            <tr>
					              ...
					              <td className="text-center">
					                <span className="dropdown">
					                   <Link to="#" className="btn" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
