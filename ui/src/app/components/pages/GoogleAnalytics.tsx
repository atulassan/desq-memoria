						            ...
						            <div className="row">
						              <div className="col-md-12">
						                <div className="form-group">
						                  <h2>Google-Authentifizierung</h2>
						                  <p>Authentifizieren Sie Ihr Google-Konto zum Abruf von Google Analytics-Einblicken für Ihr Hilfecenter.</p>
						                </div>
						              </div>
						              <div className="col-md-12">
						                <div className="form-group">
						                  <label className="ix-checkbox-label">
						                    <input type="checkbox" className="ix-checkbox" /><mark className="mr-2" /> Ich stimme den Nutzungsbedingungen und Datenschutzbestimmungen des Anbieters zu, nehme zur Kenntnis, dass die Rechte zur Nutzung dieses Produktes nicht von oneix stammen.
						                  </label>
						                </div>
						              </div>
						              <div className="col-md-12">
						                <div className="form-group mt-3">
						                   <Link to="#" className="btn-theme">Authentifizieren</Link>
						                </div>
						              </div>
						            </div>
						          </form>
