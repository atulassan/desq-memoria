					  ...
					  <div className="mainWrapperBody">
		                ...
		                <div className="setting-right">
							    ...
							    <div className="row">
							      ...
							      <div className="col-lg-6 text-right">
							        <ul className="nutzer-top">
							          <li><Link to="Neues-Profil" className="btn-theme btn-sm">Neues Profil</Link></li>
							        </ul>
							      </div>
							    </div>
							  </div>
							  <div className="Setting-right-content bt1px">
							    <div className="p20">
							      <h2>Standardprofile (3)</h2>
							      <div className="Weitere-Konfiguration Profile-Settings">
							        <ul>
							          <li>
							            <h5><Link to="kundendienstadministrator">Kundendienstadministrator </Link> </h5>
							            <p>Legen Sie Berechtigungen für Kundendienstadministratoren fest.</p>
							          </li>
							          <li>
							            <h5><Link to="nebenagent">Nebenagent</Link></h5>
							            <p>Berechtigung für Nebenagenten festlegen</p>
							          </li>
							          <li>
							            <h5><Link to="agent-settings">Agent</Link></h5>
							            <p>Berechtigungen für Standardagenten festlegen</p>
							          </li>
							        </ul>
							      </div>
							      <h2>Benutzerdefinierte Profile (3)</h2>
							      <div className="Weitere-Konfiguration Profile-Settings BenutzerdefinierteSettings">
							        <ul>
							          <li>
							            <h5><Link to="newbie-agent">Newbie Agent</Link> <Link to="#" className="hoverShow"><i className="lnr lnr-trash" /></Link></h5>
							            <p>Legen Sie Berechtigungen für neue Agenten fest.</p>
							          </li>
							          <li>
							            <h5><Link to="supervisor">Supervisor</Link> <Link to="#" className="hoverShow"><i className="lnr lnr-trash" /></Link></h5>
							            <p>Legen Sie Berechtigungen für Supervisornutzer fest.</p>
							          </li>
							          <li>
							            <h5><Link to="support-manager">Support Manager</Link> <Link to="#" className="hoverShow"><i className="lnr lnr-trash" /></Link></h5>
							            <p>Legen Sie Berechtigungen für Managernutzer fest</p>
							          </li>
							        </ul>
							      </div>
							    </div>
