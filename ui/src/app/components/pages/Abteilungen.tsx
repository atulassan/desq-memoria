						    ...
						    <div className="row">
						      ...
						      <div className="col-lg-6 text-right">
						        <ul className="nutzer-top">
						          <li><a data-href="#" className="btn-theme btn-sm">Neue Abteilung</a></li>
						        </ul>
						      </div>
						    </div>
						  </div>
						              ...
						              <div className="col-lg-12">
						                <div className="media p20">
						                  ...
						                  <div className="media-body">
						                    <h5 className="mt-0 hint-title smTitle mt-2 mb-0">one ix gmbh  <span className="badge badge-info">Standard</span> <span className="float-right"><a ><i className="lnr lnr-pencil" /></a></span></h5>
						                    <p className="mb-0">Anzeigename one ix gmbh</p>
						                    <a ><i className="lnr lnr-envelope" /> support@oneixgmbh377.oneixdesk.ch</a>
						                  </div>
						                </div>
						              </div>
						            </div>
