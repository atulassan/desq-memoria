...
export class MultiBranding extends Component{
    render(){
        return(
            <div>
		                      ...
		                      <div className="setting-left-accordion">
		                        <div className="accordion" id="accordion">
		                          ...
		                          <div className="card">
		                            ...
		                            <div id="collapse6" className="collapsed" aria-labelledby="heading6" data-parent="#accordion">
		                              <div className="card-body">
		                                <ul>
		                                  <li>
						    ...
						    <div className="row">
						      <div className="col-lg-12">
						        <div className="no-feeds mt-4 w60">
						          <p>Erstellen Sie Abteilungen für all Ihre Marken, die mit eigenen Kanälen, Nutzern und Hilfecentern arbeiten.
						          </p><div className="mb-3">
						            <img src="/assets/images/Multimarken-Hilfecenter.jpg" alt="Multimarken-Hilfecenter" />
						          </div>
						          <h1>Multimarken-Hilfecenter</h1>
						          <p>Richten Sie Multimarken mit einer gemeinsamen Nutzerbasis ein, bei denen Sie eine gemeinsame Endanwenderbasis oder eine separate Nutzerbasis für jedes einzelne Hilfecenter einrichten können.</p>
						          <div className=" mt-3 di-block"><button className="btn-theme btn-md">Multimarken aktivieren</button></div>
						        </div>
						      </div>
						    </div>
						  </div>
