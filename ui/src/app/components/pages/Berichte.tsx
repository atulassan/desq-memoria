                              ...
                              <div className="col-lg-12">
                                ...
                                <div className="p20 bg-white">
                                  <div className="row">
                                    ...
                                    <div className="col-3">
                                       <Link to="#" className="card kpi-item" data-toggle="tooltip" data-placement="bottom" title="Zur Diagrammausblendung klicken">
                                        <div className="media">
                                          ...
                                          <div className="kpi_icon">
                                            <img src="/assets/images/svg/sine-waves-green.svg" alt="sign-waves-green" />
                                          </div>
                                        </div>
                                      </Link>
                                    </div>
                                    <div className="col-3">
                                       <Link to="#" className="card kpi-item" data-toggle="tooltip" data-placement="bottom" title="Zur Diagrammausblendung klicken">
                                        ...
                                        <div className="media">
                                          ...
                                          <div className="kpi_icon">
                                            <img src="/assets/images/svg/sound-waves-orange.svg" alt="sign-waves-orange" />
                                          </div>
                                        </div>
                                      </Link>
                                    </div>
                                    <div className="col-3">
                                       <Link to="#" className="card kpi-item" data-toggle="tooltip" data-placement="bottom" title="Zur Diagrammausblendung klicken">
                                        ...
                                        <div className="media">
                                          ...
                                          <div className="kpi_icon">
                                            <img src="/assets/images/svg/sound-waves-grey.svg" alt="sign-waves-grey" />
                                          </div>
                                        </div>
                                      </Link>
                                    </div>
                                    <div className="col-3">
                                       <Link to="#" className="card kpi-item" data-toggle="tooltip" data-placement="bottom" title="Zur Diagrammausblendung klicken">
                                        ...
                                        <div className="media">
                                          ...
                                          <div className="kpi_icon">
                                            <img src="/assets/images/svg/sound-waves-red.svg" alt="sign-waves-red" />
                                          </div>
                                        </div>
                                      </Link>
                                    </div>
