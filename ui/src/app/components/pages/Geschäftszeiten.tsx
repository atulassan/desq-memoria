...
export class Geschäftszeiten extends Component{
    render(){
        return(
            <div>
		                      ...
		                      <div className="setting-left-accordion">
		                        <div className="accordion" id="accordion">
		                          ...
		                          <div className="card">
		                            ...
		                            <div id="collapse7" className="collapsed" aria-labelledby="heading7" data-parent="#accordion">
		                              <div className="card-body">
		                                <ul>
		                                  <li className="active">
							    ...
							    <div className="row">
							      ...
							      <div className="col-lg-6 text-right">
							        <ul className="nutzer-top">
							          <li><a data-href="#" className="btn-theme btn-sm">New Business Hour</a></li>
							        </ul>
							      </div>
							    </div>
							  </div>
							      ...
							      <div className="col-lg-12">
							        ...
							        <Tabs>
							          	...
							          	<TabPanel>
								            <div className="row">
								              <div className="col-lg-12">
								                <div className="no-feeds mt-4 w60">
								                  <div className="mb-3">
								                    <img src="/assets/images/geschäftszeiten.jpg" alt="geschäftszeiten" />
								                  </div>
								                  <h1>You haven't set up any business hours yet</h1>
								                  <p>Click the button below to add your business hours by selecting a time zone, operational hours, and holidays</p>
								                  <div className=" mt-3 di-block"><button className="btn-theme btn-md">Add Business Hour</button></div>
								                </div>
								              </div>
								            </div>
							          	</TabPanel>
								        <TabPanel>
								            <div className="row">
								              <div className="col-lg-12">
								                <div className="no-feeds mt-4 w60">
								                  <div className="mb-3">
								                    <img src="/assets/images/geschäftszeiten1.jpg" alt="geschäftszeiten" />
								                  </div>
								                  <h1>There aren't any inactive business hours</h1>
								                  <p>Business hours that have been disabled in your account will be listed here</p>
								                </div>
								              </div>
								            </div>
								        </TabPanel>
...
export default Geschäftszeiten
