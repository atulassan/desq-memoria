...
export class DkimAuthentication extends Component{
    render(){
        return(
            <div>
		                ...
		                <div className="setting-right">
						  ...
						  <div className="Setting-right-content">
						    <table className="table m-0">
						      <thead>
						        <tr>
						          <th className="text-center" data-width="30%">DOMÄNENNAME</th>
						          <th className="text-center" data-width="30%">ÜBERPRÜFUNGSSTATUS</th>
						          <th className="text-center" data-width="20%">LAST VERIFIED</th>
						        </tr>
						      </thead>
						    </table>
						    <div className="col-lg-12">
						      <div className="no-feeds mt-4">
						        <h1>There aren't any custom domain found</h1>
						        <p>Custom domains that are available in From and Support email addresses will be listed here</p>
						      </div>
						    </div>
						  </div>
						</div>
...
export default DkimAuthentication
