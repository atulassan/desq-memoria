...
export class DatenExportieren extends Component{
    render(){
        return(
            <div>
							          ...
							          <div className="col-md-4">
							            <div className="form-group">
							              ...
							              <select  className="form-control chosen-select">
							                <option value={0}>Agenten exportieren </option>
							                <option value={0}>Kontos exportieren </option>
							                <option value={0}>Kontakte exportieren </option>
							                <option value={0}>Aufgaben exportieren </option>
							                <option value={0}>Anrufe exportieren </option>
							                <option value={0}>Ereignisse exportieren </option>
							                <option value={0}>Produkte exportieren </option>
							                <option value={0}>Tickets exportieren </option>
							                <option value={0}>Hilfecenter exportieren</option>
							              </select>
							            </div>
							          </div>
							        </div>
...
export default DatenExportieren 
