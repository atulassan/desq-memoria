							            ...
							            <div className="mdule-organisieren-left br1px">
							              <div className="p20">
							                <div className="organisieren-left-title">
							                  <img src="/assets/images/svg/move.svg" alt="move" /> Zum Ändern der Reihenfolge ziehen
							                </div>
							                <div className="organisieren-list">
							                  <ul>
							                    ...
							                    <li><span><img src="/assets/images/svg/dial.svg" alt="dial" /></span>Community</li>
							                    <li><span><img src="/assets/images/svg/dial.svg" alt="dial" /></span>Kunden</li>
							                    <li><span><img src="/assets/images/svg/dial.svg" alt="dial" /></span>Berichte</li>
							                    <li><span><img src="/assets/images/svg/dial.svg" alt="dial" /></span>Aktivitäten</li>
							                    <li><span><img src="/assets/images/svg/dial.svg" alt="dial" /></span>Sozial</li>
							                    <li><span><img src="/assets/images/svg/dial.svg" alt="dial" /></span>Chat</li>
							                  </ul>
							                </div>
							              </div>
							            </div>
							            ...
							            <div className="mdule-organisieren-right">
							              <div className="p20">
							                ...
							                <div className="organisieren-right-img">
							                  <img src="/assets/images/gewählte-module.jpg" alt="gewählte" />
