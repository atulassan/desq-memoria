		                ...
		                <div className="setting-right">
						    ...
						    <div className="row">
						      ...
						      <div className="col-lg-6 text-right">
						        <ul className="nutzer-top">
						          <li>
						            <Link to="ticket-vorlage-bearbeiten" className="btn-theme btn-sm">Neu Ticket-Vorlage</Link>
						          </li>
						        </ul>
						      </div>
						    </div>
						  ...
						  <div className="Setting-right-content">
						    <table className="table m-0 Ticket-Status">
						      <thead>
						        <tr>
						          <th className="text-center" data-width="10%"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" /><mark /></label></th>
						          <th data-width="50%">Name</th>
						          <th className="text-center" data-width="20%">Kontakt im Hilfecenter anzeigen </th>
						          <th data-width="20%" />
						        </tr>
						      </thead>
						      <tbody>
						        <tr>
						          <td className="text-center" data-width="10%"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" /><mark /></label></td>
						          <td data-width="50%">
						          	<Link to="ticket-vorlage-bearbeiten" className="link-blue">Sar</Link>
						          </td>
						          <td className="text-center" data-width="20%">
						          	<label className="ix-radiobox-label"><input type="checkbox" className="ix-radiobox" /><mark /></label>
						          </td>
						          <td className="text-center" data-width="20%">
						          	<span className="hoverShow">
						              <Link to="ticket-vorlage-bearbeiten" data-toggle="tooltip" data-placement="bottom" title="Editieren" className="link-blue mr-2"><i className="lnr lnr-pencil" /></Link>
						              <Link to="#" data-toggle="tooltip" data-placement="bottom" title="Löschen"><i className="lnr lnr-trash" /></Link></span>
						          </td>
						        </tr>
						      </tbody>
						    </table>
