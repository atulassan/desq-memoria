						    ...
						    <div className="row">
						      ...
						      <div className="col-lg-6 text-right">
						        <ul className="nutzer-top">
						          <li><Link to="#" className="btn-theme btn-sm">Create group</Link></li>
						        </ul>
						      </div>
						    </div>
						  </div>
						    ...
						    <div className="row">
						      <div className="col-lg-12">
						        <div className="no-feeds mt-4 w60">
						          <div className="mb-3">
						            <img src="/assets/images/user-label.jpg" alt="user-group" />
						          </div>
						          <h1>Add your first group</h1>
						          <p>Add a custom user group to apply it to a knowledge base category or section to define viewing access.</p>
						          <div className=" mt-3 di-block"><Link to="#" className="btn-theme">Create group</Link></div>
						        </div>
						      </div>
						    </div>
						  </div>
