...
export class Unternehmen extends Component{
    render(){
        return(
            <div>
							    ...
							    <div className="row">
							      ...
							      <div className="col-lg-6 text-right">
							        <ul className="nutzer-top">
							          <li> <Link to="#" className="btn-theme btn-sm">Editieren</Link></li>
							        </ul>
							      </div>
							    </div>
							  </div>
							  <div className="Setting-right-content bt1px">
							    <div className="row">
							      <div className="col-lg-12">
							        <div className="company_bdrshadow">
							          <div className="media p20">
							            <img className="mr-3" src="/assets/images/company_logobg.jpg" alt="company_logo" />
							            <div className="media-body">
							              <h2 className="mt-3 ml-3">Media heading</h2>
							            </div>
							          </div>
							        </div>
							                ...
							                <div className="row">
							                  <div className="col-md-6">
							                    <div className="form-group">
							                      <label>Primärer Kontakt</label>
							                      <div><Link to="#">oneixswiss@gmail.com</Link></div>
							                    </div>
							                  </div>
							                  <div className="col-md-6">
							                    <div className="form-group">
							                  ...
							                  <div className="col-md-6">
							                    <div className="form-group">
							                      <label>Währung Gebietsschema</label>
							                      <p>Switzerland</p>
							                    </div>
							                  </div>
							                  <div className="col-md-6">
