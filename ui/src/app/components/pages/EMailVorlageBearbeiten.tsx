						      ...
						      <div className="col-lg-6 text-right">
						        <ul className="nutzer-top">
						          <li className="dropdown">
						             <Link to="#" className="btn-theme btn-sm text-white" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Hinzufügen</Link>
						            <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
						               <Link to="#" className="dropdown-item">Neue Vorlage</Link>
						               <Link to="#" className="dropdown-item">Neuer Vorlagenordner</Link>
						            </div>
						          </li>
						        </ul>
						      </div>
						          ...
						          <div className="form-page p20">
						            <form >
						              <div className="row">
						                  ...
						                  <div className="row">
						                    ...
						                    <div className="col-md-12">
						                      <div className="form-group">
						                        ...
						                        <input className="form-control" type="text"defaultValue="Notify agent on assigning a call" />
						                      </div>
						                    </div>
						                    <div className="col-md-12">
						                      <div className="form-group">
						                    ...
						                    <div className="col-md-12">
						                      <div className="form-group">
						                        ...
						                        <input className="form-control" type="text"placeholder="Eg. johnzoho.eu" />
						                      </div>
						                    </div>
						                    <div className="col-md-12">
						                      <div className="form-group">
						                        <label className="label-red">Betreff</label> 
						                        <input className="form-control" type="text"defaultValue="You have been assigned a new call" />
						                      </div>
						                    </div>
						                  </div>
						                </div>
						                    ...
						                    <div className="einladung-editor-scroll">
						                      <div className="einladung-editor-outer">
						                        <div className="einladung-editor-inner text-left">
						                          ...
						                          <p>Contact : ${'{'}Calls.Contact Name{'}'}</p>
						                ...
						                <div className="col-md-12">
						                  <div className="form-group">
						                     <Link to="#" className="link-blue mr-3 rndbtn" style={{transform: 'rotate(-45deg)'}}><i style={{position: 'relative', top: '4px'}} className="lnr lnr-paperclip" /></Link> <span className="link-blue">Anhänge</span>  (Up to 5 MB)
						                  </div>
						                </div>
						              </div>
						            </form>
