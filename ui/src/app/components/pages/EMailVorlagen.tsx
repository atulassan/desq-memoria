							                      ...
							                      <div className="row">
							                        <div className="col-md-12">
							                          <div className="form-group">
							                            ...
							                            <select  className="form-control chosen-select">
							                              ...
							                              <option value={0}>support@oneixgmbh377.oneixdesk.eu</option>
							                            </select>
							                          </div>
							                        </div>
							                        <div className="col-md-12">
							                        ...
							                        <div className="col-md-12">
							                          <div className="form-group">
							                            ...
							                            <input className="form-control" defaultValue=" Organization.Organization - Customer Self Service Portal Invitation" />
							                          </div>
							                        </div>
							                      </div>
							                    </div>
							                        ...
							                        <div className="einladung-editor-scroll">
							                          <div className="einladung-editor-outer">
							                            ...
							                            <div className="einladung-editor-inner">
							                              ...
							                              <p>our user is <span className="link-blue">${'{'}User.Email{'}'}</span> | You can also <span className="link-blue">${'{'}PortalUser.ACCEPT_PORTAL_INVITATION::click here{'}'}
							                    ...
							                    <div className="col-md-4">
							                      <div className="row">
							                        ...
							                        <div className="col-md-12">
							                          <div className="form-group">
							                            <label>Antworten an</label>
							                            <input className="form-control" type="text"placeholder="Eg. johnoneix.eu" />
							                          </div>
							                        </div>
							                        <div className="col-md-12">
							                          <div className="form-group">
							                            <label className="label-red">Betreff</label>
							                            <input className="form-control" type="text"defaultValue="Organization.Organization - Customer Self Service Portal Invitation" />
							                          </div>
							                        </div>
							                      </div>
							                    </div>
