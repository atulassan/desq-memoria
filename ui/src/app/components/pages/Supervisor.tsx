		                ...
		                <div className="setting-right">
							  ...
							  <div className="Setting-right-content bt1px">
							    <div className="profile-setting-scroll">
							      <div className="p20">
							        <div className="mb-4">
							          <div className="profileNameBase"><h2 className="mb-0">Supervisor  <Link to="#" className="hoverShow"><i className="lnr lnr-pencil" /></Link></h2></div>
							          <div id="profileNameEdit" className="mb-2" style={{display: 'none'}}>
							            <form>
							              <div className="form-row align-items-center">
							                <div className="col-auto">
							                  <input type="text" className="form-control"  defaultValue="Supervisor" />
							                </div>
							                <div className="col-auto">
