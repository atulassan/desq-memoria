...
export class StandardBerechtigungenBearbeiten extends Component{
    render(){
        return(
            <div>
							  ...
							  <div className="setting-right-title">
							    <div className="row">
							      <div className="col-lg-12">
							        Standard-Berechtigungen der Organisation bearbeiten:
							      </div>
							    </div>
							  </div>
							  <div className="Setting-right-content bt1px">
							    <div className="p20">
							      <table className="table table-bordered DatenfreigabeTable">
							        <tbody>
							          <tr>
							            <td data-width="20%">Kontos</td>
							            <td data-width="10%"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Kontos" /><mark className="mr-2" />Privat </label></td>
							            <td data-width="20%"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Kontos" /><mark className="mr-2" />Öffentliche lesen </label></td>
							            <td data-width="50%"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Kontos" defaultChecked /><mark className="mr-2" />Öffentliche lesen/Schreiben </label></td>
							          </tr>
							          <tr>
							            <td>Kontakte</td>
							            <td><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Kontakte" /><mark className="mr-2" /> Privat</label></td>
							            <td><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Kontakte" /><mark className="mr-2" /> Öffentliche lesen </label></td>
							            <td><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Kontakte" defaultChecked /><mark className="mr-2" /> Öffentliche lesen/Schreiben </label></td>
							          </tr>
							          <tr>
							            <td>Aufgaben</td>
							            <td><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Aufgaben" /><mark className="mr-2" /> Privat </label></td>
							            <td><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Aufgaben" /><mark className="mr-2" /> Öffentliche lesen </label></td>
							            <td><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Aufgaben" defaultChecked /><mark className="mr-2" /> Öffentliche lesen/Schreiben </label></td>
							          </tr>
							          <tr>
							            <td>Tickets</td>
							            <td><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Tickets" /><mark className="mr-2" />Privat </label></td>
							            <td><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Tickets" /><mark className="mr-2" />Öffentliche lesen </label></td>
							            <td><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Tickets" defaultChecked /><mark className="mr-2" />Öffentliche lesen/Schreiben </label></td>
							          </tr>
							          <tr>
							            <td>Produkte</td>
							            <td><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Produkte" /><mark className="mr-2" />Privat </label></td>
							            <td><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Produkte" /><mark className="mr-2" />Öffentliche lesen </label></td>
							            <td><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Produkte" defaultChecked /><mark className="mr-2" />Öffentliche lesen/Schreiben </label></td>
							          </tr>
							          <tr>
							            <td>Anrufe</td>
							            <td><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Anrufe" /><mark className="mr-2" />Privat </label></td>
							            <td><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Anrufe" /><mark className="mr-2" />Öffentliche lesen </label></td>
							            <td><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Anrufe" defaultChecked /><mark className="mr-2" />Öffentliche lesen/Schreiben </label></td>
							          </tr>
							          <tr>
							            <td>Ereignisse</td>
							            <td><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Ereignisse" /><mark className="mr-2" />Privat </label></td>
							            <td><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Ereignisse" /><mark className="mr-2" />Öffentliche lesen </label></td>
							            <td><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Ereignisse" defaultChecked /><mark className="mr-2" />Öffentliche lesen/Schreiben </label></td>
							          </tr>
							        </tbody>
							      </table>
							    </div>
...
export default StandardBerechtigungenBearbeiten 
