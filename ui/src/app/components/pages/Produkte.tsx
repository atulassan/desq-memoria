...
export class Produkte extends Component{
    render(){
        return(
            <div>
					  ...
					  <div className="mainWrapperBody">
		                ...
		                <div className="setting-right">
						    ...
						    <div className="row">
						      ...
						      <div className="col-lg-6 text-right">
						        <ul className="nutzer-top">
						          <li><a data-href="#" className="btn-theme btn-sm">Neue Produkt</a></li>
						        </ul>
						      </div>
						    </div>
						  </div>
						  <div className="Setting-right-content bt1px">
						        ...
						        <div className="col-lg-12">
						          <span className="dropdown">
						            <button className="btn pl-0" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
						              Alle Produkte  <i style={{position: 'relative', left: '5px', top: '1px'}} className="lnr lnr-chevron-down" />
						            </button>
						            <div className="dropdown-menu posLeft" aria-labelledby="dropdownMenuButton">
						              <div className="dropMinHeight">
						                <a data-href="#" className="dropdown-item">Alle Produkte</a>
						                <a data-href="#" className="dropdown-item">Meine Produkte</a>
						              </div>
						              <a className="link text-center drop-btn" ><i style={{position: 'relative', top: '1px', marginRight: '5px'}} className="lnr lnr-plus-circle" /> Neue Ansicht erstellen</a>
						            </div>
						          </span>
						        </div>
						      </div>
						    ...
						    <div className="row">
						      <div className="col-lg-12">
						        <p className="text-center mt-4">Produkte nicht gefunden</p>
						      </div>
						    </div>
						  </div>
						</div>
