							        ...
							        <div className="Weitere-Konfiguration">
							          <ul>
							            ...
							            <li>
							              ...
							              <p className="w-60">Agents can send outbound emails to new or existing contacts, convert them into tickets, and track their progress. Besides, such contacts do not receive the new ticket notification. <a data-href="#" className="link-blue">Mehr dazu</a></p>
							            </li>
							          </ul>
							        </div>
							      </div>
