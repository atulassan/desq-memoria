							                ...
							                <li>
							                  <div className="pleft">
							                    ...
							                    <span className="dropdown">
							                      ...
							                      <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
							                         <Link to="#" className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" /><mark className="mr-2" />Bearbeiten</label></Link>
							                         <Link to="#" className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" /><mark className="mr-2" />Löschen</label></Link>
							                        <div className="drop_btns">
							                          <button className="btn-theme btn-xs mr-1">Speichern</button>
							                ...
							                <li>
							                  <div className="pleft">
							                    ...
							                    <span className="dropdown">
							                      ...
							                      <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
							                         <Link to="#" className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" /><mark className="mr-2" />E-Mail</label></Link>
							                         ...
							                         <Link to="#" className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" /><mark className="mr-2" />Community</label></Link>
							                         <Link to="#" className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" /><mark className="mr-2" />Chat</label></Link>
							                         <Link to="#" className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" /><mark className="mr-2" />Soziales</label></Link>
							                         <Link to="#" className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" /><mark className="mr-2" />Telefonie</label></Link>
							                         <Link to="#" className="dropdown-item"><label className="ix-checkbox-label"><input type="checkbox" className="ix-checkbox" /><mark className="mr-2" />Webformular</label></Link>
							                        <div className="drop_btns">
							                          <button className="btn-theme btn-xs mr-1">Speichern</button>
							                          <Link to="#" className="btn-theme btn-sm">Abbrechen</Link>
							                        </div>
