...
export class Rollen  extends Component{
    render(){
        return(
            <div>
					  ...
					  <div className="mainWrapperBody">
		                ...
		                <div className="setting-right">
						    ...
						    <div className="row">
						      ...
						      <div className="col-lg-6 text-right">
						        <ul className="nutzer-top">
						          <li><Link to="neu-rolle" className="btn-theme btn-sm">Neu Rolle</Link></li>
						        </ul>
						      </div>
						    </div>
						  </div>
						  <div className="Setting-right-content bt1px">
						    <div className="p20">
						      <div className="mb-3">
						         <Link to="#" className="mr-3 erweitern">Alle erweitern</Link>
						         <Link to="#" className="einklappen">Alle einklappen</Link>
						      </div>
						      <div className="mainRollen"><i className="lnr lnr-circle-minus" /> sone ix gmbh</div>
						      <div className="rollenList">
						        <ul>
						          	<li>- <Link to="#">CEO </Link> 
						          		<span className="hoverShow">
						          			<Link to="neu-rolle"><i className="lnr-file-add" /></Link> 
						          			<Link to="edit-rolle"><i className="lnr-pencil" /></Link>
						          		</span>
						          	</li>
						          	<li>- <Link to="#">Manager </Link>
						          		<span className="hoverShow">
						          			<Link to="neu-rolle"><i className="lnr-file-add" /></Link>
						          			<Link to="edit-rolle"><i className="lnr-pencil" /></Link>
						          			<Link to="#"><i className="lnr-trash" /></Link>
						          		</span>
						          	</li>
						        </ul>
						      </div>
