...
export class Rebrand extends Component{
    render(){
        return(
            <div>
						  ...
						  <div className="Setting-right-content bt1px">
						    <div className="row">
						      <div className="col-lg-12">
						          ...
						          <form >
						            <div className="row">
						              <div className="col-md-3">
						                <div className="brand-logo-favicon">
						                  <ul>
						                    <li>
						                      <p>Firmenlogo</p>
						                      <div className="brand-upload">
						                        <Link to="#"><i className="fa fa-camera" /></Link>
						                        <input type="file" />
						                        <img src="/assets/images/fav-sample-icon.png" alt="fav-sample" />
						                      </div>
						                    </li>
						                    <li>
						                      <p>Favicon</p>
						              ...
						              <div className="col-md-9">
						                <div className="brand-upload-format">
						                  <p>The size of the firmenlogo should not exceed 2 MB and viewed best when its dimensions are 200:40 pixels. 
						                    <span>It should be in .jpeg, .jpg, .png or .gif format.</span></p>
						                  <p>The size of the favicon should not exceed 64 KB and viewed best when its dimensions are 32:32 pixels.
						                    <span>It should be in .jpeg, .jpg, .png or .gif format.</span></p>
						                </div>
						              </div>
						            </div>
						            <div className="row">
						              <div className="col-md-3">
						                <div className="row">
						                  <div className="col-md-12">
						                    <div className="form-group">
						                      <label>Logo-Linkback-URL</label>
						                      <input type="text" className="form-control"/>
						                    </div>
						                  </div>
						                  <div className="col-md-12">
						                    <div className="form-group">
						                      <label>Hilfecenter-Name</label>
						                      <input type="text" className="form-control"/>
						                    </div>
						                  </div>
						                </div>
						                <div className="row">
						                  ...
						                  <div className="col-md-12">
						                    <div className="form-group">
						                       <Link to="#" className="blue-link"> desk.oneix.ch</Link> <span className="badge badge-warning ml-2">Primär</span>
						                    </div>
						                  </div>
						                </div>
						              </div>
						        ...
						        <div className="col-md-12">
						          <div className="rebrandBottomBtns">
