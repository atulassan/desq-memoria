...
export class Papierkorb extends Component{
    render(){
        return(
            <div>
					  ...
					  <div className="mainWrapperBody">
		                ...
		                <div className="setting-right">
							  <div className="setting-right-title">
							    Papierkorb <span className="dropdown">
							        <Link to="#" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							        Alle(s) <i className="lnr lnr-chevron-down" />
							      </Link>
							      <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
							         <Link to="#" className="dropdown-item drop_title">Modul</Link>
							        <span className="dropSearch"><input type="text" placeholder="Suchen" /></span>
							        <div className="dropMinHeight">
							           <Link to="#" className="dropdown-item">Alle(s)</Link>
							           <Link to="#" className="dropdown-item">Verträge</Link>
							           ...
							           <Link to="#" className="dropdown-item">Produkte</Link>
