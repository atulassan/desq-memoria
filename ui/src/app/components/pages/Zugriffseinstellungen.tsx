...
export class Zugriffseinstellungen extends Component{
    render(){
        return(
            <div>
					  ...
					  <div className="mainWrapperBody">
		                ...
		                <div className="setting-right">
						  <div className="setting-right-title">
						    Hilfecenter-Zugriffseinstellungen
						  </div>
						  <div className="Setting-right-content bt1px">
						    <div className="row">
						      <div className="col-lg-12">
						        <div className="hilfecenterList p20">
						          <h2>Hilfecenter-URL</h2>
						          <ul>
						            <li><Link  to="#" className="link-blue">https://desk.oneix.ch/portal/oneixgmbh377/</Link></li>
						            <li>Verknüpfen Sie Ihre <Link  to="#" className="link-blue">spezifische Domäne </Link>mit oneix Desk</li>
						          </ul>
						          <h2>Berechtigungen</h2>
						          <ul>
						            <li>
						              <span className="firstWidth">Kunden können sich zum Hilfecenter anmelden</span>
						            ...
						            <li>
						              <span className="firstWidth">Kunden können Tickets anderer Nutzer ihres Kontos anzeigen</span>
						              <label className="switch mt-3 switch-pos">
						                <input type="checkbox" />
						                <span className="slider round" />
						              </label>
						            ...
						            <li>
						              <span className="firstWidth">Kunden müssen sich zum Zugriff auf das Hilfecenter registrieren</span>
						              <label className="switch mt-3 switch-pos">
						                <input type="checkbox" />
						                <span className="slider round" />
						              </label>
						            ...
						            <li>
						              <span className="firstWidth">Community im Hilfecenter anzeigen</span>
						              <label className="switch mt-3 switch-pos">
						                <input type="checkbox" />
						                <span className="slider round" />
						              </label>
						            ...
						            <li>
						              <span className="firstWidth">Defend your help center against Cross-site Scripting (XSS) (Recommended)</span>
						              <label className="switch mt-3 switch-pos">
						                <input type="checkbox" />
						                <span className="slider round" />
						              </label>
						          ...
						          <h2>Auto-Invite Permission</h2>
						          <ul>
						            <li>
						              <span className="firstWidth">Kunden bei erster Ticket-Absendung automatisch einladen</span>
						              <label className="switch mt-3 switch-pos">
						                <input type="checkbox" />
						                <span className="slider round" />
						              </label>
...
export default Zugriffseinstellungen
