...
export class  SalesIQ extends Component{
    render(){
        return(
            <div>
							              ...
							              <div className="row">
							                <div className="col-md-3">
							                  <div className="row">
							                    ...
							                    <div className="col-md-12">
							                      <div className="form-group">
							                        <label>Metaschlüsselwörter</label>
							                ...
							                <div className="col-md-12">
							                  ...
							                  <div className="form-group">
							                    <label className="ix-checkbox-label">
							                      <input type="radio" className="ix-checkbox" name="Registrierte_Benutzer" /><mark className="mr-2" /> Registrierte Benutzer  
							                    </label>
							                    <label className="ix-checkbox-label">
							                      <input type="radio" className="ix-checkbox" name="Registrierte_Benutzer" /><mark className="ml-3 mr-2" /> Jeder 
							                    </label>
							                  </div>
							                  <p>Wenn oneix SalesIQ aktiv ist, werden die Live-Chat-Widgets nicht im Hilfecenter angezeigt.</p>
							                </div>
							                <div className="col-md-12">
