				              ...
				              <div className="row">
				                ...
				                <div className="col-lg-6 text-right">
				                  <ul className="nutzer-top">
				                    <li><Link to="datenfreigabe-bearbeiten" className="btn-theme btn-sm">Datenfreigabe bearbeiten</Link></li>
				                  </ul>
				                </div>
				              </div>
				                ...
				                <table className="table table-bordered DatenfreigabeTable">
				                  ...
				                  <tbody>
				                    <tr>
				                      ...
				                      <td><Link to="datenfreigabe-bearbeiten" className="hoverShow"><i className="lnr lnr-pencil"></i></Link></td>
				                    </tr>
				                    <tr>
				                      <td>Kontakte</td>
				                      <td>Öffentliche lesen/Schreiben/löschen</td>
