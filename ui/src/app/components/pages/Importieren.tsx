...
export class Importieren extends Component{
    render(){
        return(
            <div>
		                      ...
		                      <div className="setting-left-accordion">
		                        <div className="accordion" id="accordion">
		                          ...
		                          <div className="card">
		                            ...
		                            <div id="collapse19" className="collapsed" aria-labelledby="heading19" data-parent="#accordion">
		                              <div className="card-body">
		                                <ul>
		                                  <li className="active">
							  ...
							  <div className="Setting-right-content">
							    ...
							    <Tabs>
			                      	<TabList className="nav-tabs">
		                        		<Tab>Daten importieren</Tab>
				                        <Tab>Importverlauf</Tab>
				                    </TabList>
								            ...
								            <form >
								                ...
								                <div className="col-md-4">
								                  <div className="form-group">
								                    ...
								                    <select  className="form-control chosen-select">
								                      <option value={0}>Kontos importieren</option>
								                      <option value={0}>Kontakte importieren</option>
								                      <option value={0}>Aufgaben importieren</option>
								                      <option value={0}>Anrufe importieren</option>
								                      <option value={0}>Ereignisse importieren</option>
								                      <option value={0}>Produkte importieren</option>
								                      <option value={0}>Tickets importieren</option>
								                      <option value={0}>Hilfecenter importieren</option>
								                    </select>
								                  </div>
								                </div>
								              </div>
								              <div className="row mt-4">
								                <div className="col-md-6">
								                  <div className="form-group">
								                    <label className="label-red">Dateipfad importieren</label>
								                    <div className="mt-3">
								                       <Link to="#" className="link-blue mr-3 rndbtn" style={{transform: 'rotate(-45deg)'}}>
								                        <i style={{position: 'relative', top: '4px'}} className="lnr lnr-paperclip" />
								                      </Link> No file chosen[Es werden nur die Formate .xls oder .csv unterstützt]
								                    </div>
								                  </div>
								                </div>
								              </div>
								        ...
								        <TabPanel>
								          <div className="p20">
								            <table className="table table-bordered">
								              <thead>
								                <tr>
								                  <th className="text-center" data-width="10%"><label className="ix-checkbox-label">
								                      <input type="checkbox" className="ix-checkbox" /><mark /></label>
								                  </th>
								                  <th data-width="20%">Name</th>
								                  <th data-width="15%">Typ</th>
								                  <th data-width="40%">Gelöscht von</th>
								                  <th data-width="15%">Gelöscht Zeit</th>
								                </tr>
								              </thead>
								              <tbody>
								                <tr>
								                  <td colSpan={5} className="text-center" data-width="10%">
							    ...
							    <div className="Setting_right_fxd_btns p20">
							      <button className="btn-theme btn-md">Weiter</button>
							    </div>
							  </div>
							</div>
