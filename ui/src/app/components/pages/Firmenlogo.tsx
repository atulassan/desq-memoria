...
export class Firmenlogo extends Component{
    render(){
        return(
            <div>
							                  ...
							                  <ul>
							                    <li>
							                      ...
							                      <div className="brand-upload">
							                        <a ><i className="fa fa-camera" /></a>
							                        <input type="file" />
							                        <img src="/assets/images/company_logobg.jpg" alt="company_logobg" />
							                      </div>
							                    </li>
							                    <li>
							                      <p>Favicon</p>
							            ...
							            <div className="row">
							              <div className="col-md-5">
							                <div className="form-group">
							                  ...
							                  <input type="text" className="form-control" placeholder="Geben Sie eine URL ein" />
							                </div>
							              </div>
							              <div className="col-md-12">
							                <div className="brand-upload-format">
							                  <p>Die Größe des Firmenlogos darf 2 MB nicht überschreiten. Die beste Darstellung ergibt sich bei einer Größe von 200 × 40 Pixeln. Mögliche
							                    <span>Dateiformate: JPEG, JPG, PNG und GIF.</span></p>
							                </div>
							              </div>
							            </div>
							          </form>
