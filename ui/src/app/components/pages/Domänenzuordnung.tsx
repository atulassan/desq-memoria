...
export class Domänenzuordnung extends Component{
    render(){
        return(
            <div>
						    ...
						    <div className="row">
						      <div className="col-lg-12">
						        <div className="no-feeds mt-4 w60">
						          <div className="mb-3">
						            <img src="/assets/images/domänenzuordnung.jpg" alt="domänenzuordnung" />
						          </div>
						          <h1>Domänen wurden noch nicht verknüpft.</h1>
						          <p>Klicken Sie zum Verknüpfen der neuen Domäne rechts oben auf „Domäne verknüpfen“.</p>
						        </div>
						      </div>
						    </div>
						  </div>
...
export default Domänenzuordnung
