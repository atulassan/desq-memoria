							    ...
							    <div className="row">
							      <div className="col-lg-12">
							        <div className="p20">
							          ...
							          <p>Learn how to generate the authentication token from our API documentation below:</p>
							          <p className="api-hilight"> <Link to="#" className="link-blue">https://desk.zoho.eu/support/APIDocument.do#OauthTokens</Link></p>
							          <p>To manage all the apps authenticated using OAuth,  <Link to="#" className="link-blue"> klicken Sie hier</Link></p>
							          <h2 className="mt-5 mb-4">API-Nutzungsbeschränkung</h2>
							          <div className=" mb-4">
							            <table className="table table-bordered">
							              <thead>
							                <tr>
							                  <th scope="col">Ausgabe</th>
							                  <th scope="col">API-Ticket – oberes Limit</th>
							                </tr>
							              </thead>
							              <tbody>
							                <tr>
							                  <td>Kostenlose Edition</td>
							                  <td>25000 requests per organization, per day</td>
							                </tr>
							                <tr>
							                  <td>Standard Edition</td>
							                  <td>50000 requests per organization, per day</td>
							                </tr>
							                <tr>
							                  <td>Professional-Edition</td>
							                  <td>75000 requests per organization, per day</td>
							                </tr>
							              </tbody>
							            </table>
							          </div>
							          <p>Zoho Service Communication-Schlüssel (ZSC)</p>
							          <p>Dieser Schlüssel wird zum Zugriff von anderen Zoho-Services auf Zoho-Desk-Module verwendet. Der erzeugte Schlüssel und die nachstehend angegebene E-Mail-Adresse sollten anderen Zoho-Services übergeben werden.</p>
							          <div className="api-list">
							            <ul>
							              <li><span> E-Mail </span>  <strong>oneixswiss@gmail.com</strong></li>
							              <li><span> ZSC-Schlüssel</span> <strong className="api-green">b85e91ccabf104aa5371756aaf9faa63</strong> <strong>Schlüssel erneut generieren</strong></li>
							              <li><span> OrgId</span> <strong>20072915031</strong></li>
							            </ul>
							          </div>
							        </div>
							      </div>
