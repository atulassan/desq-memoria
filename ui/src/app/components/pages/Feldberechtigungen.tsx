						    ...
						    <div className="row">
						      <div className="col-lg-6">
						        ...
						        <span className="dropdown">
						          ...
						          <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
						             <Link to="#" className="dropdown-item drop_title">PROFILE</Link>
						            <span className="dropSearch"><input type="text" placeholder="Suchen" /></span>
						            <div className="dropMinHeight">
						               <Link to="#" className="dropdown-item">Kundendienstadministrator</Link>
						               <Link to="#" className="dropdown-item">Nebenagent</Link>
						               <Link to="#" className="dropdown-item">Newbie Agent</Link>
						               <Link to="#" className="dropdown-item">Hilfecenter</Link>
						               <Link to="#" className="dropdown-item">Agent</Link>
						               <Link to="#" className="dropdown-item">Supervisor</Link>
						               <Link to="#" className="dropdown-item">Support Manager</Link>
						            </div>
						          </div>
						        </span>
						      </div>
						      <div className="col-lg-6 text-right">
						        <ul className="nutzer-top">
						          <li><input type="text" placeholder="Suchfelder..." /></li>
						        </ul>
						      </div>
						    </div>
						  </div>
						  <div className="Setting-right-content">
						    <div className="table-content-scroll">
						      <table className="table m-0a">
						        <thead>
						          <tr>
						            <th className="pl-3" data-width="20%">FELDNAME</th>
						            <th className="text-center" data-width="15%">LESEN/SCHREIBEN</th>
						            <th className="text-center" data-width="15%">SCHREIBGESCHÜTZT</th>
						            <th className="text-center" data-width="15%">NICHT ANZEIGEN</th>
						            <th data-width="35%" />
						          </tr>
						        </thead>
						        <tbody>
						          ...
						          <tr>
						            ...
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Anzahl-Kommentare" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Anzahl-Kommentare" /><mark /></label></td>
						            <td />
						          </tr>
						          <tr>
						            ...
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Anzahl-Threads" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Anzahl-Threads" /><mark className="radioDisabled" /></label></td>
						            <td />
						          </tr>
						          <tr>
						            <td className="pl-3"><strong>Beschreibung</strong></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Beschreibung" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Beschreibung" /><mark /></label></td>
						          ...
						          <tr>
						            ...
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="E-Mail" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="E-Mail" /><mark /></label></td>
						          ...
						          <tr>
						            ...
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Empfängeradresse" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Empfängeradresse" /><mark className="radioDisabled" /></label></td>
						            <td />
						          </tr>
						          <tr>
						            ...
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Erstellt" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Erstellt" /><mark className="radioDisabled" /></label></td>
						            <td />
						          </tr>
						          <tr>
						            ...
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Erstellungszeit" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Erstellungszeit" /><mark className="radioDisabled" /></label></td>
						            <td />
						          </tr>
						          <tr>
						            <td className="pl-3"><strong>Fälligkeitsdatum</strong></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Fälligkeitsdatum" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Fälligkeitsdatum" /><mark /></label></td>
						          ...
						          <tr>
						            ...
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Geändert" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Geändert" /><mark className="radioDisabled" /></label></td>
						            <td />
						          </tr>
						          <tr>
						            ...
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="isSpam" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="isSpam" /><mark className="radioDisabled" /></label></td>
						            <td />
						          </tr>
						          <tr>
						            ...
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="eskaliert" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="eskaliert" /><mark /></label></td>
						            <td />
						          </tr>
						          <tr>
						            ...
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="überfällig" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="überfällig" /><mark /></label></td>
						            <td />
						          </tr>
						          <tr>
						            <td className="pl-3"><strong>Kanal</strong></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Kanal" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Kanal" /><mark /></label></td>
						          ...
						          <tr>
						            ...
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Kategorie" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Kategorie" /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Kategorie" /><mark /></label></td>
						            <td />
						          </tr>
						          <tr>
						            <td className="pl-3"><strong>Klassifizierungen</strong></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Klassifizierungen" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Klassifizierungen" /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Klassifizierungen" /><mark /></label></td>
						            <td />
						          </tr>
						          <tr>
						          ...
						          <tr>
						            ...
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Konto-Name" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Konto-Name" /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Konto-Name" /><mark /></label></td>
						            <td />
						          </tr>
						          <tr>
						            <td className="pl-3"><strong>Lösung</strong></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Lösung" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Lösung" /><mark /></label></td>
						          ...
						          <tr>
						            ...
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Modifiziert" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Modifiziert" /><mark className="radioDisabled" /></label></td>
						            <td />
						          </tr>
						          <tr>
						            ...
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Neuester-Thread" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Neuester-Thread" /><mark className="radioDisabled" /></label></td>
						            <td />
						          </tr>
						          <tr>
						            <td className="pl-3"><strong>Priorität</strong></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Priorität" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Priorität" /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Priorität" /><mark /></label></td>
						            <td />
						          </tr>
						          <tr>
						            <td className="pl-3"><strong>Produkt Name</strong></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Produkt-Name" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Produkt-Name" /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Produkt-Name" /><mark /></label></td>
						            <td />
						          </tr>
						          <tr>
						            <td className="pl-3"><strong>Reaktionszeit</strong></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Reaktionszeit" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Reaktionszeit" /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Reaktionszeit" /><mark /></label></td>
						            <td />
						          </tr>
						          <tr>
						          ...
						          <tr>
						            ...
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Tel" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Tel" /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Tel" /><mark /></label></td>
						            <td />
						          </tr>
						          <tr>
						            ...
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Threadstatus" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Threadstatus" /><mark className="radioDisabled" /></label></td>
						            <td />
						          </tr>
						          <tr>
						            ...
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Ticket-Abschlusszeit" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Ticket-Abschlusszeit" /><mark className="radioDisabled" /></label></td>
						            <td />
						          </tr>
						          <tr>
						            <td className="pl-3"><strong>Ticket Besitzer</strong></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Ticket-Besitzer" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Ticket-Besitzer" /><mark /></label></td>
						          ...
						          <tr>
						            ...
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Ticket-Gehalten" /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Ticket-Gehalten" /><mark /></label></td>
						            <td />
						          </tr>
						          <tr>
						            ...
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Ticket-ID" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Ticket-ID" /><mark className="radioDisabled" /></label></td>
						            <td />
						          </tr>
						          <tr>
						            <td className="pl-3"><strong>Unterkategorie</strong></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Unterkategorie" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Unterkategorie" /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Unterkategorie" /><mark /></label></td>
						            <td />
						          </tr>
						          <tr>
						            ...
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Zufriedenheitsbewertung" defaultChecked /><mark /></label></td>
						            <td className="text-center"><label className="ix-radiobox-label"><input type="radio" className="ix-radiobox" name="Zufriedenheitsbewertung" /><mark /></label></td>
						            <td />
						          </tr>
						        </tbody>
						      </table>
