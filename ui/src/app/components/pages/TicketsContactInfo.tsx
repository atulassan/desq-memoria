...
export class TicketsContactInfo extends Component{
    render(){
        return(
            <div>
					    ...
					    <div className="ticketcolum left">
					      <div className="ticketcolumBackBtn p10">
					        ...
					        <span className=" dropdown ">
					          <Link to="#" className="pl-0 " id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
					            Tickets wählen <i style={{position: 'relative', left: '5px', top: '-1px'}} className="fa fa-sort-desc" />
					          </Link>
					          <div className="dropdown-menu posLeft" aria-labelledby="dropdownMenuButton">
					            ...
					            <div className="dropMinHeight">
					              ...
					              <Link to="#" className="dropdown-item">Alle Kontakte</Link>
					              <Link to="#" className="dropdown-item">Anonymous Kontakte</Link>
					              <Link to="#" className="dropdown-item">Kontakte mit CRM verknüpft</Link>
					              <Link to="#" className="dropdown-item">Kontakte-CRM-Verknüpfung aufgehoben</Link>
					              <Link to="#" className="dropdown-item">Last 30 days</Link>
					              <Link to="#" className="dropdown-item">Meine Kontakte</Link>
					              <Link to="#" className="dropdown-item">New Today</Link>
					              <Link to="#" className="dropdown-item">Spam Kontakte</Link>
					              <Link to="#" className="dropdown-item">Suche in</Link>
					              <Link to="#" className="dropdown-item">Archivierte Ansichten</Link>
					            </div>
					          </div>
					        </span>
					      </div>
					          ...
					          <ul>
					            <li className="active">
					              ...
					              <div className="recentTicketSmList">
					                <span className="recent-sm-list"><Link to="#">support@oneixsupport.com</Link></span>
					                <span className="recent-sm-list"><Link to="#">1 888 900 9646</Link></span>
					              </div>
					            </li>
					          </ul>
					        </div>
					      ...
					      <div className="overflowScroll">
					      	<Tabs>
		                      	<TabList className="nav-tabs">
			                        ...
			                        <Tab><i className="fa fa-history"></i></Tab>
			                     </TabList>
						                ...
						                <div className="row">
						                  <div className="col-md-12">
						                    ...
						                    <div className="contactInfoList">
						                      <ul>
						                        <li><i className="fa fa-envelope" /> support@oneixort.com</li>
						                        <li><i className="fa fa-phone" /> Handy hinzufügen</li>
						                        <li><i className="fa fa-phone-square" /> 1 888 900 9646</li>
						                      </ul>
						                      <ul style={{borderTop: '1px solid #eee'}}>
						                        <li><i className="fa fa-facebook" /> https://www.facebook.com/</li>
						                        <li><i className="fa fa-twitter" /> https://twitter.com/</li>
						                      </ul>
						                    </div>
						                    <div className="contactInfoListTxt">
						                      <p>Besitzer <span>anitha Sivakumar</span></p>
						                      <p>Titel <span>Customer Support Executive</span></p>
						                      <p>Contact Erstellungszeit <span>28.09.2020 08:36 AM</span></p>
						                    </div>
						                  </div>
						                </div>
						              </form>
					          ...
					          <div className="col-lg-12 col-md-12">
					              ...
					              <TabPanel>
					                <div className="ticket_contact_info_scroll">
					                  <div className="text-right p20"><Link to="#" className="progressBarTrigger btn-white btn-sm">Erweitern</Link></div>
					                  <div className="overAllRslt">
					                    <ul>
					                      ...
					                      <li>
					                        <div className="tktBase">
					                          <p><img src="/assets/images/emoji-smile.png" alt="emoji-smile" /> 0% <span>Zufriedenheitsbewertung</span></p>
					                        </div>
					                      </li>
					                    </ul>
					                  </div>
					                ...
					                <div className="ticket_contact_info_scroll">
					                  <div className="row">
					                    ...
					                    <div className="col-lg-6 text-right">
					                      <div className="p20">
					                        <span className="dropdown">
					                          <Link to="#"   id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"><i className="fa fa-ellipsis-h" /></Link>
					                      ...
					                      <ul>
					                        ...
					                        <li className="timeline-item">
					                          ...
					                          <div className="timeline-cont">
					                            ...
					                            <div className="mt-1">
					                              <span className="tline-label">Konto <span className="tline-val">Sar</span></span>
					                              <span className="tline-label">Kontakt <span className="tline-val">Sar</span></span>
					                    ...
					                    <div className="row">
					                      ...
					                      <div className="col-lg-6 text-right">
					                        <ul className="rightSmList">
					                          <li className="dropdown">Fälligkeitsdatum / Anfangszeit <Link to="#" className="pl-0 " id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"><i style={{position: 'relative', left: '5px', top: '-1px'}} className="fa fa-sort-desc" /></Link>
					                            <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
					                          ...
					                          <li>
					                            <Link to="#" className="pl-0 " data-toggle="tooltip" data-placement="bottom"data-original-title="Neueste Einträge zuerst anzeigen">
					                    ...
					                    <div className="row">
					                      <div className="col-lg-4">
					                        <div className="TicketsTopLeft">
					                          <span className="dropdown">
					                            <Link to="#" className="mt-2" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
					                    ...
					                    <div className="row">
					                      <div className="col-lg-6">
					                        <div className="ratingTopLeft">
					                          <span className="mr-2">Zufriedenheitsbewertung</span> 
					                          <span><img src="/assets/images/emoji-smile.png" alt="emoji-smile" /></span> 
					                  ...
					                  <div className="ticketcolum_right_nr_btns">
					                    <div className="row">
					                      ...
					                      <div className="col-lg-7 text-right ">
					                        <Link to="#" className="btn-theme btn-sm">Kommentar</Link>
...
export default TicketsContactInfo
