...
export class Absenderadresse extends Component{
    render(){
        return(
            <div>
					  ...
					  <div className="mainWrapperBody">
		                ...
		                <div className="setting-right">
							  <div className="setting-right-title">
							    Absenderadresse <span className="float-right"><Link to="#"  className="btn-theme btn-sm">Neue Absenderadresse</Link></span>
							  </div>
							  <div className="Setting-right-content">
							    <table className="table m-0">
							      <thead>
							        <tr>
							          <th className="text-center" data-width="20%">ABSENDERADRESSE</th>
							          <th className="text-center" data-width="20%">LESEFREUNDLICHER NAME</th>
							          <th className="text-center" data-width="20%">ÜBERPRÜFUNGSSTATUS</th>
							          <th className="text-center" data-width="20%">ALLE STATUS</th>
							          <th className="text-center" data-width="20%" />
							        </tr>
							      </thead>
							      <tbody>
							        <tr>
							          <td className="text-center"><div className="hlpcnt"><Link to="#"  className="link-blue">support@oneixgmbh377.oneix.ch</Link></div></td>
							          <td className="text-center"><div className="hlpcnt">one ix gmbh</div></td>
							          <td className="text-center"><div className="hlpcnt">Überprüft</div></td>
							          ...
							          <td className="text-center">
							            <span className="dropdown">
							               <Link to="#" className="btn " type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
							                <i className="fa fa-ellipsis-h" />
							              </Link>
							              <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
							                <Link to="#"  className="dropdown-item">Editieren</Link>
...
export default Absenderadresse
