...
export class ErweitertesWebformular extends Component{
    render(){
        return(
            <div>
		                      ...
		                      <div className="setting-left-accordion">
		                        <div className="accordion" id="accordion">
		                          ...
		                          <div className="card">
		                            ...
		                            <div id="collapse4" className="collapsed" aria-labelledby="heading4" data-parent="#accordion">
		                              <div className="card-body">
		                                <ul>
		                                  <li>
						    ...
						    <div className="row">
						      <div className="col-lg-12">
						        <div className="no-feeds mt-4 w60">
						          <div className="mb-3">
						            <img src="/assets/images/Erweitertes-Webformular.jpg" alt="Erweitertes-Webformular" />
						          </div>
						          <h1>Sie haben keine Webformulare konfiguriert.</h1>
						          <p>Webformulare vereinfachen die Erfassung von Kundendienst-tickets Ihrer Website zur Verarbeitung in Ihrem Helpdesk.</p>
						          <div className=" mt-3 di-block"><button className="btn-theme btn-md">Erweitertes Webformular erstellen</button></div>
						        </div>
						      </div>
						    </div>
						  </div>
...
export default ErweitertesWebformular
