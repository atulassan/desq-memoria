...
export class  HilfecenterSAML  extends Component{
    render(){
        return(
            <div>
							      ...
							      <div className="col-lg-12">
							        ...
							        <Tabs>
								          ...
								          <TabPanel>
								                      ...
								                      <div className="row">
								                        <div className="col-md-12">
								                          <div className="form-group">
								                            <label>URL für die Remoteanmeldung</label>
								                            <input type="text" className="form-control"/>
								                          </div>
								                        </div>
								                        <div className="col-md-12">
								                          <div className="form-group">
								                            <label>Externabmeldung-URL</label>
								                            <input type="text" className="form-control"/>
								                          </div>
								                        </div>
								                        <div className="col-md-12">
								                          <div className="form-group">
								                            <label>Kennwort-rücksetzen-URL</label>
								                            <input type="text" className="form-control"/>
								                          </div>
								                        </div>
								                        <div className="col-md-12">
								                          <div className="form-group">
								                            <label>Öffentlicher Schlüssel (öffentlichen Schlüssel nur in Datei mit TXT- oder PEM-Erweiterung angeben)</label>
								                            <input type="file" className="form-control"style={{border: '0px'}} />
								                          </div>
								                        </div>
								                      ...
								                      <div className="row">
								                        <div className="col-md-12">
								                          <div className="form-group mt-4">
								                            <h5>Hilfecenter-SAML-Anfrage-URL</h5>
								                            <p>https://accounts.oneixportal.eu/accounts/csamlrequest/30002173103</p>
								                          </div>
								                        </div>
								                        <div className="col-md-12">
								                          <div className="form-group">
								                            <h5>Hilfecenter-SAML-Antwort-URL</h5>
								                            <p>https://accounts.oneixportal.eu/accounts/csamlresponse/30002173103</p>
								                          </div>
								                        </div>
								                        <div className="col-md-12">
								                          <div className="form-group">
								                            <h5>Standard-Relaiszustand</h5>
								                            <p>aHR0cHM6Ly9kZXNrLnpvaG8uZXUvcG9ydGFsL29uZWl4Z21iaDM3Ny8=</p>
								                          </div>
								                        </div>
								                        <div className="col-md-12">
								                          <div className="form-group">
								                            <h5>Redirect URL (For Microsoft Azure)</h5>
								                            <p>https://accounts.oneixportal.eu/accounts/csamlrequest/30002173103?serviceurl
								                              =https%3A%2F%2Fdesk.oneix.eu%2Fportal%2Foneixgmbh377%2F</p>
								                          </div>
								                        </div>
								                        <div className="col-md-12">
								                          <div className="form-group">
								                            <label>Entity  (Issuer) </label>
								                            <div className="mb-2">
								                              <label className="ix-checkbox-label">
								                                <input type="radio" className="ix-checkbox" name="Entity" /><mark className="mr-2" /> oneix.ch
								                              </label>
								                            </div>
								                            <div>
								                              <label className="ix-checkbox-label">
								                                <input type="radio" className="ix-checkbox" name="Entity" /><mark className="mr-2" /> desk.oneix.ch
								                              </label>
								                            </div>
								                          </div>
								                        </div>
								            ...
								            <div className="Setting_right_fxd_btns p20 ml-2" style={{left: '15px'}}>
								          ...
								          <TabPanel>
								            <div className="ticketcolum_right_scroll">
								              <div className="row">
								                <div className="col-md-12">
								                  <div className="p20">Domänenzuordnung | Schließen Sie  <Link to="#" className="link-blue">Domänenverknüpfung</Link> zum Einrichten der externen Authentifizierung ab.</div>
								                </div>
								              </div>
								            </div>
								          </TabPanel>
...
export default  HilfecenterSAML
