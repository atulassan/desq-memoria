...
export class NeuesProfil  extends Component{
    render(){
        return(
            <div>
							                ...
							                <div className="row">
							                  <div className="col-md-12">
							                    <div className="form-group">
							                      <label className="label-red">Profilname</label>
							                      <input type="text" className="form-control"/>
							                    </div>
							                  </div>
							                  <div className="col-md-12">
							                    <div className="form-group">
							                      <label className="label-red">Klonieren Profil</label>
							                      <select className="form-control chosen-select">
							                        <option value={0}>Kundendienstadministrator</option>
							                        <option value={0}>Nebenagent</option>
							                        <option value={0}>Newbie Agent</option>
							                        <option value={0}>Agent</option>
							                        <option value={0}>Supervisor</option>
							                        <option value={0}>Support Manager</option>
							                      </select>
							                    </div>
							                  </div>
							                  <div className="col-md-12">
							                    <div className="form-group">
							                      <label>Klonieren Profil</label>
