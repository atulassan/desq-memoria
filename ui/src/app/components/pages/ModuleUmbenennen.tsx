...
export class ModuleUmbenennen extends Component{
    render(){
        return(
            <div>
		                      ...
		                      <div className="setting-left-accordion">
		                        <div className="accordion" id="accordion">
		                          ...
		                          <div className="card">
		                            ...
		                            <div id="collapse13" className="collapsed" aria-labelledby="heading13" data-parent="#accordion">
		                              <div className="card-body">
		                                <ul>
		                                  <li>
							  ...
							  <div className="Setting-right-content bt1px">
							    <div className="row">
							      <div className="col-lg-12">
							        <div className="row">
							          <div className="col-lg-12">
							            <div className="mdule-organisieren-left">
							              <div className="p20">
							                <div className="umbenennen-list">
							                  <ul>
							                    <li>
							                      <div className="media">
							                        <span className="iconWidth"><span className="icon icon1" /></span>
							                        <div className="media-body">
							                          <h5 className="mt-0">Verträge <Link to="#" data-toggle="modal" data-target="#umbenennen"><i className="lnr lnr-pencil" /></Link></h5>
							                          Anzeigename Verträge
							                        </div>
							                      </div>
							                    </li>
							                    <li>
							                      <div className="media">
							                        <span className="iconWidth"><span className="icon icon2" /></span>
							                        <div className="media-body">
							                          <h5 className="mt-0">Verträge <i className="lnr lnr-pencil" /></h5>
							                          Anzeigename Verträge
							                        </div>
							                      </div>
							                    </li>
							                    <li>
							                      <div className="media">
							                        <span className="iconWidth"><span className="icon icon3" /></span>
							                        <div className="media-body">
							                          <h5 className="mt-0">Verträge <i className="lnr lnr-pencil" /></h5>
							                          Anzeigename Verträge
							                        </div>
							                    ...
							                    <li>
							                      <div className="media">
							                        <span className="iconWidth"><span className="icon icon4" /></span>
							                        <div className="media-body">
							                          <h5 className="mt-0">Verträge <i className="lnr lnr-pencil" /></h5>
							                          Anzeigename Verträge
							                        </div>
							                    ...
							                    <li>
							                      <div className="media">
							                        <span className="iconWidth"><span className="icon icon5" /></span>
							                        <div className="media-body">
							                          <h5 className="mt-0">Verträge <i className="lnr lnr-pencil" /></h5>
							                          Anzeigename Verträge
							                        </div>
							                    ...
							                    <li>
							                      <div className="media">
							                        <span className="iconWidth"><span className="icon icon6" /></span>
							                        <div className="media-body">
							                          <h5 className="mt-0">Verträge <i className="lnr lnr-pencil" /></h5>
							                          Anzeigename Verträge
							                        </div>
							                    ...
							                    <li>
							                      <div className="media">
							                        <span className="iconWidth"><span className="icon icon7" /></span>
							                        <div className="media-body">
							                          <h5 className="mt-0">Verträge <i className="lnr lnr-pencil" /></h5>
							                          Anzeigename Verträge
							                        </div>
							                    ...
							                    <li>
							                      <div className="media">
							                        <span className="iconWidth"><span className="icon icon8" /></span>
							                        <div className="media-body">
							                          <h5 className="mt-0">Verträge <i className="lnr lnr-pencil" /></h5>
							                          Anzeigename Verträge
							                        </div>
							                    ...
							                    <li>
							                      <div className="media">
							                        <span className="iconWidth"><span className="icon icon9" /></span>
							                        <div className="media-body">
							                          <h5 className="mt-0">Verträge <i className="lnr lnr-pencil" /></h5>
							                          Anzeigename Verträge
							                        </div>
							                    ...
							                    <li>
							                      <div className="media">
							                        <span className="iconWidth"><span className="icon icon10" /></span>
							                        <div className="media-body">
							                          <h5 className="mt-0">Verträge <i className="lnr lnr-pencil" /></h5>
							                          Anzeigename Verträge
							                        </div>
							                    ...
							                    <li>
							                      <div className="media">
							                        <span className="iconWidth"><span className="icon icon11" /></span>
							                        <div className="media-body">
							                          <h5 className="mt-0">Verträge <i className="lnr lnr-pencil" /></h5>
							                          Anzeigename Verträge
							                        </div>
							                    ...
							                    <li>
							                      <div className="media">
							                        <span className="iconWidth"><span className="icon icon12" /></span>
							                        <div className="media-body">
							                          <h5 className="mt-0">Verträge <i className="lnr lnr-pencil" /></h5>
							                          Anzeigename Verträge
							                        </div>
							                    ...
							                    <li>
							                      <div className="media">
							                        <span className="iconWidth"><span className="icon icon13" /></span>
							                        <div className="media-body">
							                          <h5 className="mt-0">Verträge <i className="lnr lnr-pencil" /></h5>
							                          Anzeigename Verträge
							                        </div>
							                    ...
							                    <li>
							                      <div className="media">
							                        <span className="iconWidth"><span className="icon icon14" /></span>
							                        <div className="media-body">
							                          <h5 className="mt-0">Verträge <i className="lnr lnr-pencil" /></h5>
							                          Anzeigename Verträge
							                        </div>
							                    ...
							                    <li>
							                      <div className="media">
							                        <span className="iconWidth"><span className="icon icon15" /></span>
							                        <div className="media-body">
							                          <h5 className="mt-0">Verträge <i className="lnr lnr-pencil" /></h5>
							                          Anzeigename Verträge
							                        </div>
							                    ...
							                    <li>
							                      <div className="media">
							                        <span className="iconWidth"><span className="icon icon16" /></span>
							                        <div className="media-body">
							                          <h5 className="mt-0">Verträge <i className="lnr lnr-pencil" /></h5>
							                          Anzeigename Verträge
							                        </div>
...
export default ModuleUmbenennen
