		               ...
		               <div className="setting-right">
						    ...
						    <div className="row">
						      ...
						      <div className="col-lg-6 text-right">
						        <ul className="nutzer-top">
						          <li><input type="text"placeholder="Felder oder Datentypen suchen..." /></li>
						          <li><Link  to="#" className="btn-theme btn-sm">Felder erstellen oder bearbeiten</Link></li>
						        </ul>
						      </div>
						    </div>
						  </div>
						  <div className="Setting-right-content">
						    <table className="table m-0">
						      <thead>
						        <tr>
						          <th className="text-left pl-3" data-width="20%">FELDNAME</th>
						          <th className="text-left" data-width="20%">DATENTYP</th>
						          <th className="text-left" data-width="20%">API NAME</th>
						        </tr>
						      </thead>
						      <tbody>
						        <tr>
